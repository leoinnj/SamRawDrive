...
/* ************************************************************************** */
/** \defgroup SAMC21N18A_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  SYSTEM_IRQn              =  0, /**<  0 SAMC21N18A System Interrupts */
  WDT_IRQn                 =  1, /**<  1 SAMC21N18A Watchdog Timer (WDT) */
  RTC_IRQn                 =  2, /**<  2 SAMC21N18A Real-Time Counter (RTC) */
  EIC_IRQn                 =  3, /**<  3 SAMC21N18A External Interrupt Controller (EIC) */
  FREQM_IRQn               =  4, /**<  4 SAMC21N18A Frequency Meter (FREQM) */
  TSENS_IRQn               =  5, /**<  5 SAMC21N18A Temperature Sensor (TSENS) */
  NVMCTRL_IRQn             =  6, /**<  6 SAMC21N18A Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  7, /**<  7 SAMC21N18A Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMC21N18A Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMC21N18A Serial Communication Interface 0 (SERCOM0) */
  SERCOM6_IRQn             =  9, /**<  9 SAMC21N18A Serial Communication Interface 6 (SERCOM6) */
  SERCOM1_IRQn             = 10, /**< 10 SAMC21N18A Serial Communication Interface 1 (SERCOM1) */
  SERCOM7_IRQn             = 10, /**< 10 SAMC21N18A Serial Communication Interface 7 (SERCOM7) */
  SERCOM2_IRQn             = 11, /**< 11 SAMC21N18A Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMC21N18A Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMC21N18A Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMC21N18A Serial Communication Interface 5 (SERCOM5) */
  CAN0_IRQn                = 15, /**< 15 SAMC21N18A Control Area Network 0 (CAN0) */
  CAN1_IRQn                = 16, /**< 16 SAMC21N18A Control Area Network 1 (CAN1) */
  TCC0_IRQn                = 17, /**< 17 SAMC21N18A Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 18, /**< 18 SAMC21N18A Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 19, /**< 19 SAMC21N18A Timer Counter Control 2 (TCC2) */
  TC0_IRQn                 = 20, /**< 20 SAMC21N18A Basic Timer Counter 0 (TC0) */
  TC5_IRQn                 = 20, /**< 20 SAMC21N18A Basic Timer Counter 5 (TC5) */
  TC1_IRQn                 = 21, /**< 21 SAMC21N18A Basic Timer Counter 1 (TC1) */
  TC6_IRQn                 = 21, /**< 21 SAMC21N18A Basic Timer Counter 6 (TC6) */
  TC2_IRQn                 = 22, /**< 22 SAMC21N18A Basic Timer Counter 2 (TC2) */
  TC7_IRQn                 = 22, /**< 22 SAMC21N18A Basic Timer Counter 7 (TC7) */
  TC3_IRQn                 = 23, /**< 23 SAMC21N18A Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 24, /**< 24 SAMC21N18A Basic Timer Counter 4 (TC4) */
  ADC0_IRQn                = 25, /**< 25 SAMC21N18A Analog Digital Converter 0 (ADC0) */
  ADC1_IRQn                = 26, /**< 26 SAMC21N18A Analog Digital Converter 1 (ADC1) */
  AC_IRQn                  = 27, /**< 27 SAMC21N18A Analog Comparators (AC) */
  DAC_IRQn                 = 28, /**< 28 SAMC21N18A Digital Analog Converter (DAC) */
  SDADC_IRQn               = 29, /**< 29 SAMC21N18A Sigma-Delta Analog Digital Converter (SDADC) */
  PTC_IRQn                 = 30, /**< 30 SAMC21N18A Peripheral Touch Controller (PTC) */
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMC21N18A */
/* ************************************************************************** */
/** \defgroup SAMC21N18A_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC21N18A_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC21N18A_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMC21N18A */
/* ************************************************************************** */
/** \defgroup SAMC21N18A_port PORT Definitions */
/*@{*/
...
#define DSU_DID_RESETVALUE    _UL(0x11011400)
#define AC_PAIRS              2
