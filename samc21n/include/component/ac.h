...
#define AC_CTRLB_START_Msk          (_U(0xF) << AC_CTRLB_START_Pos)
#define AC_CTRLB_START(value)       (AC_CTRLB_START_Msk & ((value) << AC_CTRLB_START_Pos))
#define AC_CTRLB_MASK               _U(0x0F)     /**< \brief (AC_CTRLB) MASK Register */
...
#define AC_EVCTRL_COMPEO_Msk        (_U(0xF) << AC_EVCTRL_COMPEO_Pos)
...
#define AC_EVCTRL_WINEO_Msk         (_U(0x3) << AC_EVCTRL_WINEO_Pos)
...
#define AC_EVCTRL_COMPEI_Msk        (_U(0xF) << AC_EVCTRL_COMPEI_Pos)
...
#define AC_EVCTRL_INVEI_Msk         (_U(0xF) << AC_EVCTRL_INVEI_Pos)
#define AC_EVCTRL_INVEI(value)      (AC_EVCTRL_INVEI_Msk & ((value) << AC_EVCTRL_INVEI_Pos))
#define AC_EVCTRL_MASK              _U(0xFF3F)   /**< \brief (AC_EVCTRL) MASK Register */
...
#define AC_INTENCLR_COMP_Msk        (_U(0xF) << AC_INTENCLR_COMP_Pos)
...
#define AC_INTENCLR_WIN_Msk         (_U(0x3) << AC_INTENCLR_WIN_Pos)
#define AC_INTENCLR_WIN(value)      (AC_INTENCLR_WIN_Msk & ((value) << AC_INTENCLR_WIN_Pos))
#define AC_INTENCLR_MASK            _U(0x3F)     /**< \brief (AC_INTENCLR) MASK Register */
...
#define AC_INTENSET_COMP_Msk        (_U(0xF) << AC_INTENSET_COMP_Pos)
...
#define AC_INTENSET_WIN_Msk         (_U(0x3) << AC_INTENSET_WIN_Pos)
#define AC_INTENSET_WIN(value)      (AC_INTENSET_WIN_Msk & ((value) << AC_INTENSET_WIN_Pos))
#define AC_INTENSET_MASK            _U(0x3F)     /**< \brief (AC_INTENSET) MASK Register */
...
#define AC_INTFLAG_COMP_Msk         (_U(0xF) << AC_INTFLAG_COMP_Pos)
...
#define AC_INTFLAG_WIN_Msk          (_U(0x3) << AC_INTFLAG_WIN_Pos)
#define AC_INTFLAG_WIN(value)       (AC_INTFLAG_WIN_Msk & ((value) << AC_INTFLAG_WIN_Pos))
#define AC_INTFLAG_MASK             _U(0x3F)     /**< \brief (AC_INTFLAG) MASK Register */
...
#define AC_STATUSA_STATE_Msk        (_U(0xF) << AC_STATUSA_STATE_Pos)
...
#define AC_STATUSA_WSTATE1_Msk      (_U(0x3) << AC_STATUSA_WSTATE1_Pos)
#define AC_STATUSA_WSTATE1(value)   (AC_STATUSA_WSTATE1_Msk & ((value) << AC_STATUSA_WSTATE1_Pos))
#define   AC_STATUSA_WSTATE1_ABOVE_Val    _U(0x0)   /**< \brief (AC_STATUSA) Signal is above window */
#define   AC_STATUSA_WSTATE1_INSIDE_Val   _U(0x1)   /**< \brief (AC_STATUSA) Signal is inside window */
#define   AC_STATUSA_WSTATE1_BELOW_Val    _U(0x2)   /**< \brief (AC_STATUSA) Signal is below window */
...
#define AC_STATUSA_MASK             _U(0xFF)     /**< \brief (AC_STATUSA) MASK Register */
...
#define AC_STATUSB_READY_Msk        (_U(0xF) << AC_STATUSB_READY_Pos)
#define AC_STATUSB_READY(value)     (AC_STATUSB_READY_Msk & ((value) << AC_STATUSB_READY_Pos))
#define AC_STATUSB_MASK             _U(0x0F)     /**< \brief (AC_STATUSB) MASK Register */
...
#define AC_WINCTRL_WEN1             (_U(0x1) << AC_WINCTRL_WEN1_Pos)
#define AC_WINCTRL_WINTSEL1_Pos     5            /**< \brief (AC_WINCTRL) Window 1 Interrupt Selection */
#define AC_WINCTRL_WINTSEL1_Msk     (_U(0x3) << AC_WINCTRL_WINTSEL1_Pos)
#define AC_WINCTRL_WINTSEL1(value)  (AC_WINCTRL_WINTSEL1_Msk & ((value) << AC_WINCTRL_WINTSEL1_Pos))
#define   AC_WINCTRL_WINTSEL1_ABOVE_Val   _U(0x0)   /**< \brief (AC_WINCTRL) Interrupt on signal above window */
#define   AC_WINCTRL_WINTSEL1_INSIDE_Val  _U(0x1)   /**< \brief (AC_WINCTRL) Interrupt on signal inside window */
#define   AC_WINCTRL_WINTSEL1_BELOW_Val   _U(0x2)   /**< \brief (AC_WINCTRL) Interrupt on signal below window */
#define   AC_WINCTRL_WINTSEL1_OUTSIDE_Val _U(0x3)   /**< \brief (AC_WINCTRL) Interrupt on signal outside window */
...
#define AC_WINCTRL_MASK             _U(0x77)     /**< \brief (AC_WINCTRL) MASK Register */
...
#define AC_COMPCTRL_MASK            _U(0x370BF75E) /**< \brief (AC_COMPCTRL) MASK Register */
...
#define AC_SYNCBUSY_COMPCTRL_Msk    (_U(0xF) << AC_SYNCBUSY_COMPCTRL_Pos)
#define AC_SYNCBUSY_COMPCTRL(value) (AC_SYNCBUSY_COMPCTRL_Msk & ((value) << AC_SYNCBUSY_COMPCTRL_Pos))
#define AC_SYNCBUSY_MASK            _U(0x0000007F) /**< \brief (AC_SYNCBUSY) MASK Register */
