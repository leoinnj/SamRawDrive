...
#define CAN_CREL_RESETVALUE         _U(0x32100000); /**< \brief (CAN_CREL reset_value) Core Release */

#define CAN_CREL_SUBSTEP_Pos        20           /**< \brief (CAN_CREL) Sub-step of Core Release */
#define CAN_CREL_SUBSTEP_Msk        (_U(0xF) << CAN_CREL_SUBSTEP_Pos)
...
#define CAN_CREL_STEP_Msk           (_U(0xF) << CAN_CREL_STEP_Pos)
...
#define CAN_CREL_REL_Msk            (_U(0xF) << CAN_CREL_REL_Pos)
#define CAN_CREL_REL(value)         (CAN_CREL_REL_Msk & ((value) << CAN_CREL_REL_Pos))
#define CAN_CREL_MASK               _U(0xFFF00000) /**< \brief (CAN_CREL) MASK Register */
...
#define CAN_ENDN_RESETVALUE         _U(0x87654321); /**< \brief (CAN_ENDN reset_value) Endian */

#define CAN_ENDN_ETV_Pos            0            /**< \brief (CAN_ENDN) Endianness Test Value */
#define CAN_ENDN_ETV_Msk            (_U(0xFFFFFFFF) << CAN_ENDN_ETV_Pos)
#define CAN_ENDN_ETV(value)         (CAN_ENDN_ETV_Msk & ((value) << CAN_ENDN_ETV_Pos))
#define CAN_ENDN_MASK               _U(0xFFFFFFFF) /**< \brief (CAN_ENDN) MASK Register */
...
#define CAN_MRCFG_RESETVALUE        _U(0x00000002); /**< \brief (CAN_MRCFG reset_value) Message RAM Configuration */

#define CAN_MRCFG_QOS_Pos           0            /**< \brief (CAN_MRCFG) Quality of Service */
#define CAN_MRCFG_QOS_Msk           (_U(0x3) << CAN_MRCFG_QOS_Pos)
#define CAN_MRCFG_QOS(value)        (CAN_MRCFG_QOS_Msk & ((value) << CAN_MRCFG_QOS_Pos))
#define   CAN_MRCFG_QOS_DISABLE_Val       _U(0x0)   /**< \brief (CAN_MRCFG) Background (no sensitive operation) */
#define   CAN_MRCFG_QOS_LOW_Val           _U(0x1)   /**< \brief (CAN_MRCFG) Sensitive Bandwidth */
#define   CAN_MRCFG_QOS_MEDIUM_Val        _U(0x2)   /**< \brief (CAN_MRCFG) Sensitive Latency */
#define   CAN_MRCFG_QOS_HIGH_Val          _U(0x3)   /**< \brief (CAN_MRCFG) Critical Latency */
...
#define CAN_MRCFG_MASK              _U(0x00000003) /**< \brief (CAN_MRCFG) MASK Register */
...
#define CAN_DBTP_RESETVALUE         _U(0x00000A33); /**< \brief (CAN_DBTP reset_value) Fast Bit Timing and Prescaler */

#define CAN_DBTP_DSJW_Pos           0            /**< \brief (CAN_DBTP) Data (Re)Synchronization Jump Width */
#define CAN_DBTP_DSJW_Msk           (_U(0xF) << CAN_DBTP_DSJW_Pos)
...
#define CAN_DBTP_DTSEG2_Msk         (_U(0xF) << CAN_DBTP_DTSEG2_Pos)
...
#define CAN_DBTP_DTSEG1_Msk         (_U(0x1F) << CAN_DBTP_DTSEG1_Pos)
...
#define CAN_DBTP_DBRP_Msk           (_U(0x1F) << CAN_DBTP_DBRP_Pos)
...
#define CAN_DBTP_TDC                (_U(0x1) << CAN_DBTP_TDC_Pos)
#define CAN_DBTP_MASK               _U(0x009F1FFF) /**< \brief (CAN_DBTP) MASK Register */
...
#define CAN_TEST_RESETVALUE         _U(0x00000000); /**< \brief (CAN_TEST reset_value) Test */

#define CAN_TEST_LBCK_Pos           4            /**< \brief (CAN_TEST) Loop Back Mode */
#define CAN_TEST_LBCK               (_U(0x1) << CAN_TEST_LBCK_Pos)
#define CAN_TEST_TX_Pos             5            /**< \brief (CAN_TEST) Control of Transmit Pin */
#define CAN_TEST_TX_Msk             (_U(0x3) << CAN_TEST_TX_Pos)
#define CAN_TEST_TX(value)          (CAN_TEST_TX_Msk & ((value) << CAN_TEST_TX_Pos))
#define   CAN_TEST_TX_CORE_Val            _U(0x0)   /**< \brief (CAN_TEST) TX controlled by CAN core */
#define   CAN_TEST_TX_SAMPLE_Val          _U(0x1)   /**< \brief (CAN_TEST) TX monitoring sample point */
#define   CAN_TEST_TX_DOMINANT_Val        _U(0x2)   /**< \brief (CAN_TEST) Dominant (0) level at pin CAN_TX */
#define   CAN_TEST_TX_RECESSIVE_Val       _U(0x3)   /**< \brief (CAN_TEST) Recessive (1) level at pin CAN_TX */
...
#define CAN_TEST_RX                 (_U(0x1) << CAN_TEST_RX_Pos)
#define CAN_TEST_MASK               _U(0x000000F0) /**< \brief (CAN_TEST) MASK Register */
...
#define CAN_NBTP_RESETVALUE         _U(0x06000A03); /**< \brief (CAN_NBTP reset_value) Nominal Bit Timing and Prescaler */

#define CAN_NBTP_NTSEG2_Pos         0            /**< \brief (CAN_NBTP) Nominal Time segment after sample point */
#define CAN_NBTP_NTSEG2_Msk         (_U(0x7F) << CAN_NBTP_NTSEG2_Pos)
...
#define CAN_NBTP_NTSEG1_Msk         (_U(0xFF) << CAN_NBTP_NTSEG1_Pos)
...
#define CAN_NBTP_NBRP_Msk           (_U(0x1FF) << CAN_NBTP_NBRP_Pos)
...
#define CAN_NBTP_NSJW_Msk           (_U(0x7F) << CAN_NBTP_NSJW_Pos)
#define CAN_NBTP_NSJW(value)        (CAN_NBTP_NSJW_Msk & ((value) << CAN_NBTP_NSJW_Pos))
#define CAN_NBTP_MASK               _U(0xFFFFFF7F) /**< \brief (CAN_NBTP) MASK Register */
...
#define CAN_TSCC_RESETVALUE         _U(0x00000000); /**< \brief (CAN_TSCC reset_value) Timestamp Counter Configuration */

#define CAN_TSCC_TSS_Pos            0            /**< \brief (CAN_TSCC) Timestamp Select */
#define CAN_TSCC_TSS_Msk            (_U(0x3) << CAN_TSCC_TSS_Pos)
#define CAN_TSCC_TSS(value)         (CAN_TSCC_TSS_Msk & ((value) << CAN_TSCC_TSS_Pos))
#define   CAN_TSCC_TSS_ZERO_Val           _U(0x0)   /**< \brief (CAN_TSCC) Timestamp counter value always 0x0000 */
#define   CAN_TSCC_TSS_INC_Val            _U(0x1)   /**< \brief (CAN_TSCC) Timestamp counter value incremented by TCP */
#define   CAN_TSCC_TSS_EXT_Val            _U(0x2)   /**< \brief (CAN_TSCC) External timestamp counter value used */
...
#define CAN_TSCC_TCP_Msk            (_U(0xF) << CAN_TSCC_TCP_Pos)
#define CAN_TSCC_TCP(value)         (CAN_TSCC_TCP_Msk & ((value) << CAN_TSCC_TCP_Pos))
#define CAN_TSCC_MASK               _U(0x000F0003) /**< \brief (CAN_TSCC) MASK Register */
...
#define CAN_TSCV_RESETVALUE         _U(0x00000000); /**< \brief (CAN_TSCV reset_value) Timestamp Counter Value */

#define CAN_TSCV_TSC_Pos            0            /**< \brief (CAN_TSCV) Timestamp Counter */
#define CAN_TSCV_TSC_Msk            (_U(0xFFFF) << CAN_TSCV_TSC_Pos)
#define CAN_TSCV_TSC(value)         (CAN_TSCV_TSC_Msk & ((value) << CAN_TSCV_TSC_Pos))
#define CAN_TSCV_MASK               _U(0x0000FFFF) /**< \brief (CAN_TSCV) MASK Register */
...
#define CAN_TOCC_RESETVALUE         _U(0xFFFF0000); /**< \brief (CAN_TOCC reset_value) Timeout Counter Configuration */

#define CAN_TOCC_ETOC_Pos           0            /**< \brief (CAN_TOCC) Enable Timeout Counter */
#define CAN_TOCC_ETOC               (_U(0x1) << CAN_TOCC_ETOC_Pos)
#define CAN_TOCC_TOS_Pos            1            /**< \brief (CAN_TOCC) Timeout Select */
#define CAN_TOCC_TOS_Msk            (_U(0x3) << CAN_TOCC_TOS_Pos)
#define CAN_TOCC_TOS(value)         (CAN_TOCC_TOS_Msk & ((value) << CAN_TOCC_TOS_Pos))
#define   CAN_TOCC_TOS_CONT_Val           _U(0x0)   /**< \brief (CAN_TOCC) Continuout operation */
#define   CAN_TOCC_TOS_TXEF_Val           _U(0x1)   /**< \brief (CAN_TOCC) Timeout controlled by TX Event FIFO */
#define   CAN_TOCC_TOS_RXF0_Val           _U(0x2)   /**< \brief (CAN_TOCC) Timeout controlled by Rx FIFO 0 */
#define   CAN_TOCC_TOS_RXF1_Val           _U(0x3)   /**< \brief (CAN_TOCC) Timeout controlled by Rx FIFO 1 */
...
#define CAN_TOCC_TOP_Msk            (_U(0xFFFF) << CAN_TOCC_TOP_Pos)
#define CAN_TOCC_TOP(value)         (CAN_TOCC_TOP_Msk & ((value) << CAN_TOCC_TOP_Pos))
#define CAN_TOCC_MASK               _U(0xFFFF0007) /**< \brief (CAN_TOCC) MASK Register */
...
#define CAN_TOCV_RESETVALUE         _U(0x0000FFFF); /**< \brief (CAN_TOCV reset_value) Timeout Counter Value */

#define CAN_TOCV_TOC_Pos            0            /**< \brief (CAN_TOCV) Timeout Counter */
#define CAN_TOCV_TOC_Msk            (_U(0xFFFF) << CAN_TOCV_TOC_Pos)
#define CAN_TOCV_TOC(value)         (CAN_TOCV_TOC_Msk & ((value) << CAN_TOCV_TOC_Pos))
#define CAN_TOCV_MASK               _U(0x0000FFFF) /**< \brief (CAN_TOCV) MASK Register */
...
#define CAN_ECR_RESETVALUE          _U(0x00000000); /**< \brief (CAN_ECR reset_value) Error Counter */

#define CAN_ECR_TEC_Pos             0            /**< \brief (CAN_ECR) Transmit Error Counter */
#define CAN_ECR_TEC_Msk             (_U(0xFF) << CAN_ECR_TEC_Pos)
...
#define CAN_ECR_REC_Msk             (_U(0x7F) << CAN_ECR_REC_Pos)
...
#define CAN_ECR_RP                  (_U(0x1) << CAN_ECR_RP_Pos)
#define CAN_ECR_CEL_Pos             16           /**< \brief (CAN_ECR) CAN Error Logging */
#define CAN_ECR_CEL_Msk             (_U(0xFF) << CAN_ECR_CEL_Pos)
#define CAN_ECR_CEL(value)          (CAN_ECR_CEL_Msk & ((value) << CAN_ECR_CEL_Pos))
#define CAN_ECR_MASK                _U(0x00FFFFFF) /**< \brief (CAN_ECR) MASK Register */
...
#define CAN_PSR_RESETVALUE          _U(0x00000707); /**< \brief (CAN_PSR reset_value) Protocol Status */

#define CAN_PSR_LEC_Pos             0            /**< \brief (CAN_PSR) Last Error Code */
#define CAN_PSR_LEC_Msk             (_U(0x7) << CAN_PSR_LEC_Pos)
#define CAN_PSR_LEC(value)          (CAN_PSR_LEC_Msk & ((value) << CAN_PSR_LEC_Pos))
#define   CAN_PSR_LEC_NONE_Val            _U(0x0)   /**< \brief (CAN_PSR) No Error */
#define   CAN_PSR_LEC_STUFF_Val           _U(0x1)   /**< \brief (CAN_PSR) Stuff Error */
#define   CAN_PSR_LEC_FORM_Val            _U(0x2)   /**< \brief (CAN_PSR) Form Error */
#define   CAN_PSR_LEC_ACK_Val             _U(0x3)   /**< \brief (CAN_PSR) Ack Error */
#define   CAN_PSR_LEC_BIT1_Val            _U(0x4)   /**< \brief (CAN_PSR) Bit1 Error */
#define   CAN_PSR_LEC_BIT0_Val            _U(0x5)   /**< \brief (CAN_PSR) Bit0 Error */
#define   CAN_PSR_LEC_CRC_Val             _U(0x6)   /**< \brief (CAN_PSR) CRC Error */
#define   CAN_PSR_LEC_NC_Val              _U(0x7)   /**< \brief (CAN_PSR) No Change */
...
#define CAN_PSR_ACT_Msk             (_U(0x3) << CAN_PSR_ACT_Pos)
#define CAN_PSR_ACT(value)          (CAN_PSR_ACT_Msk & ((value) << CAN_PSR_ACT_Pos))
#define   CAN_PSR_ACT_SYNC_Val            _U(0x0)   /**< \brief (CAN_PSR) Node is synchronizing on CAN communication */
#define   CAN_PSR_ACT_IDLE_Val            _U(0x1)   /**< \brief (CAN_PSR) Node is neither receiver nor transmitter */
#define   CAN_PSR_ACT_RX_Val              _U(0x2)   /**< \brief (CAN_PSR) Node is operating as receiver */
#define   CAN_PSR_ACT_TX_Val              _U(0x3)   /**< \brief (CAN_PSR) Node is operating as transmitter */
...
#define CAN_PSR_EP                  (_U(0x1) << CAN_PSR_EP_Pos)
#define CAN_PSR_EW_Pos              6            /**< \brief (CAN_PSR) Warning Status */
#define CAN_PSR_EW                  (_U(0x1) << CAN_PSR_EW_Pos)
#define CAN_PSR_BO_Pos              7            /**< \brief (CAN_PSR) Bus_Off Status */
#define CAN_PSR_BO                  (_U(0x1) << CAN_PSR_BO_Pos)
#define CAN_PSR_DLEC_Pos            8            /**< \brief (CAN_PSR) Data Phase Last Error Code */
#define CAN_PSR_DLEC_Msk            (_U(0x7) << CAN_PSR_DLEC_Pos)
#define CAN_PSR_DLEC(value)         (CAN_PSR_DLEC_Msk & ((value) << CAN_PSR_DLEC_Pos))
#define   CAN_PSR_DLEC_NONE_Val           _U(0x0)   /**< \brief (CAN_PSR) No Error */
#define   CAN_PSR_DLEC_STUFF_Val          _U(0x1)   /**< \brief (CAN_PSR) Stuff Error */
#define   CAN_PSR_DLEC_FORM_Val           _U(0x2)   /**< \brief (CAN_PSR) Form Error */
#define   CAN_PSR_DLEC_ACK_Val            _U(0x3)   /**< \brief (CAN_PSR) Ack Error */
#define   CAN_PSR_DLEC_BIT1_Val           _U(0x4)   /**< \brief (CAN_PSR) Bit1 Error */
#define   CAN_PSR_DLEC_BIT0_Val           _U(0x5)   /**< \brief (CAN_PSR) Bit0 Error */
#define   CAN_PSR_DLEC_CRC_Val            _U(0x6)   /**< \brief (CAN_PSR) CRC Error */
#define   CAN_PSR_DLEC_NC_Val             _U(0x7)   /**< \brief (CAN_PSR) No Change */
...
#define CAN_TDCR_RESETVALUE         _U(0x00000000); /**< \brief (CAN_TDCR reset_value) Extended ID Filter Configuration */

#define CAN_TDCR_TDCF_Pos           0            /**< \brief (CAN_TDCR) Transmitter Delay Compensation Filter Length */
#define CAN_TDCR_TDCF_Msk           (_U(0x7F) << CAN_TDCR_TDCF_Pos)
...
#define CAN_TDCR_TDCO_Msk           (_U(0x7F) << CAN_TDCR_TDCO_Pos)
#define CAN_TDCR_TDCO(value)        (CAN_TDCR_TDCO_Msk & ((value) << CAN_TDCR_TDCO_Pos))
#define CAN_TDCR_MASK               _U(0x00007F7F) /**< \brief (CAN_TDCR) MASK Register */
...
#define CAN_ILE_RESETVALUE          _U(0x00000000); /**< \brief (CAN_ILE reset_value) Interrupt Line Enable */

#define CAN_ILE_EINT0_Pos           0            /**< \brief (CAN_ILE) Enable Interrupt Line 0 */
#define CAN_ILE_EINT0               (_U(0x1) << CAN_ILE_EINT0_Pos)
#define CAN_ILE_EINT1_Pos           1            /**< \brief (CAN_ILE) Enable Interrupt Line 1 */
#define CAN_ILE_EINT1               (_U(0x1) << CAN_ILE_EINT1_Pos)
#define CAN_ILE_MASK                _U(0x00000003) /**< \brief (CAN_ILE) MASK Register */
...
#define CAN_GFC_RESETVALUE          _U(0x00000000); /**< \brief (CAN_GFC reset_value) Global Filter Configuration */

#define CAN_GFC_RRFE_Pos            0            /**< \brief (CAN_GFC) Reject Remote Frames Extended */
#define CAN_GFC_RRFE                (_U(0x1) << CAN_GFC_RRFE_Pos)
#define CAN_GFC_RRFS_Pos            1            /**< \brief (CAN_GFC) Reject Remote Frames Standard */
#define CAN_GFC_RRFS                (_U(0x1) << CAN_GFC_RRFS_Pos)
#define CAN_GFC_ANFE_Pos            2            /**< \brief (CAN_GFC) Accept Non-matching Frames Extended */
#define CAN_GFC_ANFE_Msk            (_U(0x3) << CAN_GFC_ANFE_Pos)
#define CAN_GFC_ANFE(value)         (CAN_GFC_ANFE_Msk & ((value) << CAN_GFC_ANFE_Pos))
#define   CAN_GFC_ANFE_RXF0_Val           _U(0x0)   /**< \brief (CAN_GFC) Accept in Rx FIFO 0 */
#define   CAN_GFC_ANFE_RXF1_Val           _U(0x1)   /**< \brief (CAN_GFC) Accept in Rx FIFO 1 */
#define   CAN_GFC_ANFE_REJECT_Val         _U(0x2)   /**< \brief (CAN_GFC) Reject */
...
#define CAN_GFC_ANFS_Msk            (_U(0x3) << CAN_GFC_ANFS_Pos)
#define CAN_GFC_ANFS(value)         (CAN_GFC_ANFS_Msk & ((value) << CAN_GFC_ANFS_Pos))
#define   CAN_GFC_ANFS_RXF0_Val           _U(0x0)   /**< \brief (CAN_GFC) Accept in Rx FIFO 0 */
#define   CAN_GFC_ANFS_RXF1_Val           _U(0x1)   /**< \brief (CAN_GFC) Accept in Rx FIFO 1 */
#define   CAN_GFC_ANFS_REJECT_Val         _U(0x2)   /**< \brief (CAN_GFC) Reject */
...
#define CAN_GFC_MASK                _U(0x0000003F) /**< \brief (CAN_GFC) MASK Register */
...
#define CAN_SIDFC_RESETVALUE        _U(0x00000000); /**< \brief (CAN_SIDFC reset_value) Standard ID Filter Configuration */

#define CAN_SIDFC_FLSSA_Pos         0            /**< \brief (CAN_SIDFC) Filter List Standard Start Address */
#define CAN_SIDFC_FLSSA_Msk         (_U(0xFFFF) << CAN_SIDFC_FLSSA_Pos)
...
#define CAN_SIDFC_LSS_Msk           (_U(0xFF) << CAN_SIDFC_LSS_Pos)
#define CAN_SIDFC_LSS(value)        (CAN_SIDFC_LSS_Msk & ((value) << CAN_SIDFC_LSS_Pos))
#define CAN_SIDFC_MASK              _U(0x00FFFFFF) /**< \brief (CAN_SIDFC) MASK Register */
...
#define CAN_XIDFC_RESETVALUE        _U(0x00000000); /**< \brief (CAN_XIDFC reset_value) Extended ID Filter Configuration */

#define CAN_XIDFC_FLESA_Pos         0            /**< \brief (CAN_XIDFC) Filter List Extended Start Address */
#define CAN_XIDFC_FLESA_Msk         (_U(0xFFFF) << CAN_XIDFC_FLESA_Pos)
...
#define CAN_XIDFC_LSE_Msk           (_U(0x7F) << CAN_XIDFC_LSE_Pos)
#define CAN_XIDFC_LSE(value)        (CAN_XIDFC_LSE_Msk & ((value) << CAN_XIDFC_LSE_Pos))
#define CAN_XIDFC_MASK              _U(0x007FFFFF) /**< \brief (CAN_XIDFC) MASK Register */
...
#define CAN_XIDAM_RESETVALUE        _U(0x1FFFFFFF); /**< \brief (CAN_XIDAM reset_value) Extended ID AND Mask */

#define CAN_XIDAM_EIDM_Pos          0            /**< \brief (CAN_XIDAM) Extended ID Mask */
#define CAN_XIDAM_EIDM_Msk          (_U(0x1FFFFFFF) << CAN_XIDAM_EIDM_Pos)
#define CAN_XIDAM_EIDM(value)       (CAN_XIDAM_EIDM_Msk & ((value) << CAN_XIDAM_EIDM_Pos))
#define CAN_XIDAM_MASK              _U(0x1FFFFFFF) /**< \brief (CAN_XIDAM) MASK Register */
...
#define CAN_HPMS_RESETVALUE         _U(0x00000000); /**< \brief (CAN_HPMS reset_value) High Priority Message Status */

#define CAN_HPMS_BIDX_Pos           0            /**< \brief (CAN_HPMS) Buffer Index */
#define CAN_HPMS_BIDX_Msk           (_U(0x3F) << CAN_HPMS_BIDX_Pos)
...
#define CAN_HPMS_MSI_Msk            (_U(0x3) << CAN_HPMS_MSI_Pos)
#define CAN_HPMS_MSI(value)         (CAN_HPMS_MSI_Msk & ((value) << CAN_HPMS_MSI_Pos))
#define   CAN_HPMS_MSI_NONE_Val           _U(0x0)   /**< \brief (CAN_HPMS) No FIFO selected */
#define   CAN_HPMS_MSI_LOST_Val           _U(0x1)   /**< \brief (CAN_HPMS) FIFO message lost */
#define   CAN_HPMS_MSI_FIFO0_Val          _U(0x2)   /**< \brief (CAN_HPMS) Message stored in FIFO 0 */
#define   CAN_HPMS_MSI_FIFO1_Val          _U(0x3)   /**< \brief (CAN_HPMS) Message stored in FIFO 1 */
...
#define CAN_HPMS_FIDX_Msk           (_U(0x7F) << CAN_HPMS_FIDX_Pos)
...
#define CAN_HPMS_FLST               (_U(0x1) << CAN_HPMS_FLST_Pos)
#define CAN_HPMS_MASK               _U(0x0000FFFF) /**< \brief (CAN_HPMS) MASK Register */
...
#define CAN_RXF0C_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF0C reset_value) Rx FIFO 0 Configuration */

#define CAN_RXF0C_F0SA_Pos          0            /**< \brief (CAN_RXF0C) Rx FIFO 0 Start Address */
#define CAN_RXF0C_F0SA_Msk          (_U(0xFFFF) << CAN_RXF0C_F0SA_Pos)
...
#define CAN_RXF0C_F0S_Msk           (_U(0x7F) << CAN_RXF0C_F0S_Pos)
...
#define CAN_RXF0C_F0WM_Msk          (_U(0x7F) << CAN_RXF0C_F0WM_Pos)
...
#define CAN_RXF0C_F0OM              (_U(0x1) << CAN_RXF0C_F0OM_Pos)
#define CAN_RXF0C_MASK              _U(0xFF7FFFFF) /**< \brief (CAN_RXF0C) MASK Register */
...
#define CAN_RXF0S_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF0S reset_value) Rx FIFO 0 Status */

#define CAN_RXF0S_F0FL_Pos          0            /**< \brief (CAN_RXF0S) Rx FIFO 0 Fill Level */
#define CAN_RXF0S_F0FL_Msk          (_U(0x7F) << CAN_RXF0S_F0FL_Pos)
...
#define CAN_RXF0S_F0GI_Msk          (_U(0x3F) << CAN_RXF0S_F0GI_Pos)
...
#define CAN_RXF0S_F0PI_Msk          (_U(0x3F) << CAN_RXF0S_F0PI_Pos)
...
#define CAN_RXF0S_F0F               (_U(0x1) << CAN_RXF0S_F0F_Pos)
#define CAN_RXF0S_RF0L_Pos          25           /**< \brief (CAN_RXF0S) Rx FIFO 0 Message Lost */
#define CAN_RXF0S_RF0L              (_U(0x1) << CAN_RXF0S_RF0L_Pos)
#define CAN_RXF0S_MASK              _U(0x033F3F7F) /**< \brief (CAN_RXF0S) MASK Register */
...
#define CAN_RXF0A_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF0A reset_value) Rx FIFO 0 Acknowledge */

#define CAN_RXF0A_F0AI_Pos          0            /**< \brief (CAN_RXF0A) Rx FIFO 0 Acknowledge Index */
#define CAN_RXF0A_F0AI_Msk          (_U(0x3F) << CAN_RXF0A_F0AI_Pos)
#define CAN_RXF0A_F0AI(value)       (CAN_RXF0A_F0AI_Msk & ((value) << CAN_RXF0A_F0AI_Pos))
#define CAN_RXF0A_MASK              _U(0x0000003F) /**< \brief (CAN_RXF0A) MASK Register */
...
#define CAN_RXBC_RESETVALUE         _U(0x00000000); /**< \brief (CAN_RXBC reset_value) Rx Buffer Configuration */

#define CAN_RXBC_RBSA_Pos           0            /**< \brief (CAN_RXBC) Rx Buffer Start Address */
#define CAN_RXBC_RBSA_Msk           (_U(0xFFFF) << CAN_RXBC_RBSA_Pos)
#define CAN_RXBC_RBSA(value)        (CAN_RXBC_RBSA_Msk & ((value) << CAN_RXBC_RBSA_Pos))
#define CAN_RXBC_MASK               _U(0x0000FFFF) /**< \brief (CAN_RXBC) MASK Register */
...
#define CAN_RXF1C_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF1C reset_value) Rx FIFO 1 Configuration */

#define CAN_RXF1C_F1SA_Pos          0            /**< \brief (CAN_RXF1C) Rx FIFO 1 Start Address */
#define CAN_RXF1C_F1SA_Msk          (_U(0xFFFF) << CAN_RXF1C_F1SA_Pos)
...
#define CAN_RXF1C_F1S_Msk           (_U(0x7F) << CAN_RXF1C_F1S_Pos)
...
#define CAN_RXF1C_F1WM_Msk          (_U(0x7F) << CAN_RXF1C_F1WM_Pos)
...
#define CAN_RXF1C_F1OM              (_U(0x1) << CAN_RXF1C_F1OM_Pos)
#define CAN_RXF1C_MASK              _U(0xFF7FFFFF) /**< \brief (CAN_RXF1C) MASK Register */
...
#define CAN_RXF1S_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF1S reset_value) Rx FIFO 1 Status */

#define CAN_RXF1S_F1FL_Pos          0            /**< \brief (CAN_RXF1S) Rx FIFO 1 Fill Level */
#define CAN_RXF1S_F1FL_Msk          (_U(0x7F) << CAN_RXF1S_F1FL_Pos)
...
#define CAN_RXF1S_F1GI_Msk          (_U(0x3F) << CAN_RXF1S_F1GI_Pos)
...
#define CAN_RXF1S_F1PI_Msk          (_U(0x3F) << CAN_RXF1S_F1PI_Pos)
...
#define CAN_RXF1S_F1F               (_U(0x1) << CAN_RXF1S_F1F_Pos)
#define CAN_RXF1S_RF1L_Pos          25           /**< \brief (CAN_RXF1S) Rx FIFO 1 Message Lost */
#define CAN_RXF1S_RF1L              (_U(0x1) << CAN_RXF1S_RF1L_Pos)
#define CAN_RXF1S_DMS_Pos           30           /**< \brief (CAN_RXF1S) Debug Message Status */
#define CAN_RXF1S_DMS_Msk           (_U(0x3) << CAN_RXF1S_DMS_Pos)
#define CAN_RXF1S_DMS(value)        (CAN_RXF1S_DMS_Msk & ((value) << CAN_RXF1S_DMS_Pos))
#define   CAN_RXF1S_DMS_IDLE_Val          _U(0x0)   /**< \brief (CAN_RXF1S) Idle state */
#define   CAN_RXF1S_DMS_DBGA_Val          _U(0x1)   /**< \brief (CAN_RXF1S) Debug message A received */
#define   CAN_RXF1S_DMS_DBGB_Val          _U(0x2)   /**< \brief (CAN_RXF1S) Debug message A/B received */
#define   CAN_RXF1S_DMS_DBGC_Val          _U(0x3)   /**< \brief (CAN_RXF1S) Debug message A/B/C received, DMA request set */
...
#define CAN_RXF1S_MASK              _U(0xC33F3F7F) /**< \brief (CAN_RXF1S) MASK Register */
...
#define CAN_RXF1A_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXF1A reset_value) Rx FIFO 1 Acknowledge */

#define CAN_RXF1A_F1AI_Pos          0            /**< \brief (CAN_RXF1A) Rx FIFO 1 Acknowledge Index */
#define CAN_RXF1A_F1AI_Msk          (_U(0x3F) << CAN_RXF1A_F1AI_Pos)
#define CAN_RXF1A_F1AI(value)       (CAN_RXF1A_F1AI_Msk & ((value) << CAN_RXF1A_F1AI_Pos))
#define CAN_RXF1A_MASK              _U(0x0000003F) /**< \brief (CAN_RXF1A) MASK Register */
...
#define CAN_RXESC_RESETVALUE        _U(0x00000000); /**< \brief (CAN_RXESC reset_value) Rx Buffer / FIFO Element Size Configuration */

#define CAN_RXESC_F0DS_Pos          0            /**< \brief (CAN_RXESC) Rx FIFO 0 Data Field Size */
#define CAN_RXESC_F0DS_Msk          (_U(0x7) << CAN_RXESC_F0DS_Pos)
#define CAN_RXESC_F0DS(value)       (CAN_RXESC_F0DS_Msk & ((value) << CAN_RXESC_F0DS_Pos))
#define   CAN_RXESC_F0DS_DATA8_Val        _U(0x0)   /**< \brief (CAN_RXESC) 8 byte data field */
#define   CAN_RXESC_F0DS_DATA12_Val       _U(0x1)   /**< \brief (CAN_RXESC) 12 byte data field */
#define   CAN_RXESC_F0DS_DATA16_Val       _U(0x2)   /**< \brief (CAN_RXESC) 16 byte data field */
#define   CAN_RXESC_F0DS_DATA20_Val       _U(0x3)   /**< \brief (CAN_RXESC) 20 byte data field */
#define   CAN_RXESC_F0DS_DATA24_Val       _U(0x4)   /**< \brief (CAN_RXESC) 24 byte data field */
#define   CAN_RXESC_F0DS_DATA32_Val       _U(0x5)   /**< \brief (CAN_RXESC) 32 byte data field */
#define   CAN_RXESC_F0DS_DATA48_Val       _U(0x6)   /**< \brief (CAN_RXESC) 48 byte data field */
#define   CAN_RXESC_F0DS_DATA64_Val       _U(0x7)   /**< \brief (CAN_RXESC) 64 byte data field */
...
#define CAN_RXESC_F1DS_Msk          (_U(0x7) << CAN_RXESC_F1DS_Pos)
#define CAN_RXESC_F1DS(value)       (CAN_RXESC_F1DS_Msk & ((value) << CAN_RXESC_F1DS_Pos))
#define   CAN_RXESC_F1DS_DATA8_Val        _U(0x0)   /**< \brief (CAN_RXESC) 8 byte data field */
#define   CAN_RXESC_F1DS_DATA12_Val       _U(0x1)   /**< \brief (CAN_RXESC) 12 byte data field */
#define   CAN_RXESC_F1DS_DATA16_Val       _U(0x2)   /**< \brief (CAN_RXESC) 16 byte data field */
#define   CAN_RXESC_F1DS_DATA20_Val       _U(0x3)   /**< \brief (CAN_RXESC) 20 byte data field */
#define   CAN_RXESC_F1DS_DATA24_Val       _U(0x4)   /**< \brief (CAN_RXESC) 24 byte data field */
#define   CAN_RXESC_F1DS_DATA32_Val       _U(0x5)   /**< \brief (CAN_RXESC) 32 byte data field */
#define   CAN_RXESC_F1DS_DATA48_Val       _U(0x6)   /**< \brief (CAN_RXESC) 48 byte data field */
#define   CAN_RXESC_F1DS_DATA64_Val       _U(0x7)   /**< \brief (CAN_RXESC) 64 byte data field */
...
#define CAN_RXESC_RBDS_Msk          (_U(0x7) << CAN_RXESC_RBDS_Pos)
#define CAN_RXESC_RBDS(value)       (CAN_RXESC_RBDS_Msk & ((value) << CAN_RXESC_RBDS_Pos))
#define   CAN_RXESC_RBDS_DATA8_Val        _U(0x0)   /**< \brief (CAN_RXESC) 8 byte data field */
#define   CAN_RXESC_RBDS_DATA12_Val       _U(0x1)   /**< \brief (CAN_RXESC) 12 byte data field */
#define   CAN_RXESC_RBDS_DATA16_Val       _U(0x2)   /**< \brief (CAN_RXESC) 16 byte data field */
#define   CAN_RXESC_RBDS_DATA20_Val       _U(0x3)   /**< \brief (CAN_RXESC) 20 byte data field */
#define   CAN_RXESC_RBDS_DATA24_Val       _U(0x4)   /**< \brief (CAN_RXESC) 24 byte data field */
#define   CAN_RXESC_RBDS_DATA32_Val       _U(0x5)   /**< \brief (CAN_RXESC) 32 byte data field */
#define   CAN_RXESC_RBDS_DATA48_Val       _U(0x6)   /**< \brief (CAN_RXESC) 48 byte data field */
#define   CAN_RXESC_RBDS_DATA64_Val       _U(0x7)   /**< \brief (CAN_RXESC) 64 byte data field */
...
#define CAN_RXESC_MASK              _U(0x00000777) /**< \brief (CAN_RXESC) MASK Register */
...
#define CAN_TXBC_RESETVALUE         _U(0x00000000); /**< \brief (CAN_TXBC reset_value) Tx Buffer Configuration */

#define CAN_TXBC_TBSA_Pos           0            /**< \brief (CAN_TXBC) Tx Buffers Start Address */
#define CAN_TXBC_TBSA_Msk           (_U(0xFFFF) << CAN_TXBC_TBSA_Pos)
...
#define CAN_TXBC_NDTB_Msk           (_U(0x3F) << CAN_TXBC_NDTB_Pos)
...
#define CAN_TXBC_TFQS_Msk           (_U(0x3F) << CAN_TXBC_TFQS_Pos)
...
#define CAN_TXBC_TFQM               (_U(0x1) << CAN_TXBC_TFQM_Pos)
#define CAN_TXBC_MASK               _U(0x7F3FFFFF) /**< \brief (CAN_TXBC) MASK Register */
...
#define CAN_TXFQS_RESETVALUE        _U(0x00000000); /**< \brief (CAN_TXFQS reset_value) Tx FIFO / Queue Status */

#define CAN_TXFQS_TFFL_Pos          0            /**< \brief (CAN_TXFQS) Tx FIFO Free Level */
#define CAN_TXFQS_TFFL_Msk          (_U(0x3F) << CAN_TXFQS_TFFL_Pos)
...
#define CAN_TXFQS_TFGI_Msk          (_U(0x1F) << CAN_TXFQS_TFGI_Pos)
...
#define CAN_TXFQS_TFQPI_Msk         (_U(0x1F) << CAN_TXFQS_TFQPI_Pos)
...
#define CAN_TXFQS_TFQF              (_U(0x1) << CAN_TXFQS_TFQF_Pos)
#define CAN_TXFQS_MASK              _U(0x003F1F3F) /**< \brief (CAN_TXFQS) MASK Register */
...
#define CAN_TXESC_RESETVALUE        _U(0x00000000); /**< \brief (CAN_TXESC reset_value) Tx Buffer Element Size Configuration */

#define CAN_TXESC_TBDS_Pos          0            /**< \brief (CAN_TXESC) Tx Buffer Data Field Size */
#define CAN_TXESC_TBDS_Msk          (_U(0x7) << CAN_TXESC_TBDS_Pos)
#define CAN_TXESC_TBDS(value)       (CAN_TXESC_TBDS_Msk & ((value) << CAN_TXESC_TBDS_Pos))
#define   CAN_TXESC_TBDS_DATA8_Val        _U(0x0)   /**< \brief (CAN_TXESC) 8 byte data field */
#define   CAN_TXESC_TBDS_DATA12_Val       _U(0x1)   /**< \brief (CAN_TXESC) 12 byte data field */
#define   CAN_TXESC_TBDS_DATA16_Val       _U(0x2)   /**< \brief (CAN_TXESC) 16 byte data field */
#define   CAN_TXESC_TBDS_DATA20_Val       _U(0x3)   /**< \brief (CAN_TXESC) 20 byte data field */
#define   CAN_TXESC_TBDS_DATA24_Val       _U(0x4)   /**< \brief (CAN_TXESC) 24 byte data field */
#define   CAN_TXESC_TBDS_DATA32_Val       _U(0x5)   /**< \brief (CAN_TXESC) 32 byte data field */
#define   CAN_TXESC_TBDS_DATA48_Val       _U(0x6)   /**< \brief (CAN_TXESC) 48 byte data field */
#define   CAN_TXESC_TBDS_DATA64_Val       _U(0x7)   /**< \brief (CAN_TXESC) 64 byte data field */
...
#define CAN_TXESC_MASK              _U(0x00000007) /**< \brief (CAN_TXESC) MASK Register */
...
#define CAN_TXEFC_RESETVALUE        _U(0x00000000); /**< \brief (CAN_TXEFC reset_value) Tx Event FIFO Configuration */

#define CAN_TXEFC_EFSA_Pos          0            /**< \brief (CAN_TXEFC) Event FIFO Start Address */
#define CAN_TXEFC_EFSA_Msk          (_U(0xFFFF) << CAN_TXEFC_EFSA_Pos)
...
#define CAN_TXEFC_EFS_Msk           (_U(0x3F) << CAN_TXEFC_EFS_Pos)
...
#define CAN_TXEFC_EFWM_Msk          (_U(0x3F) << CAN_TXEFC_EFWM_Pos)
#define CAN_TXEFC_EFWM(value)       (CAN_TXEFC_EFWM_Msk & ((value) << CAN_TXEFC_EFWM_Pos))
#define CAN_TXEFC_MASK              _U(0x3F3FFFFF) /**< \brief (CAN_TXEFC) MASK Register */
...
#define CAN_TXEFS_RESETVALUE        _U(0x00000000); /**< \brief (CAN_TXEFS reset_value) Tx Event FIFO Status */

#define CAN_TXEFS_EFFL_Pos          0            /**< \brief (CAN_TXEFS) Event FIFO Fill Level */
#define CAN_TXEFS_EFFL_Msk          (_U(0x3F) << CAN_TXEFS_EFFL_Pos)
...
#define CAN_TXEFS_EFGI_Msk          (_U(0x1F) << CAN_TXEFS_EFGI_Pos)
...
#define CAN_TXEFS_EFPI_Msk          (_U(0x1F) << CAN_TXEFS_EFPI_Pos)
...
#define CAN_TXEFS_EFF               (_U(0x1) << CAN_TXEFS_EFF_Pos)
#define CAN_TXEFS_TEFL_Pos          25           /**< \brief (CAN_TXEFS) Tx Event FIFO Element Lost */
#define CAN_TXEFS_TEFL              (_U(0x1) << CAN_TXEFS_TEFL_Pos)
#define CAN_TXEFS_MASK              _U(0x031F1F3F) /**< \brief (CAN_TXEFS) MASK Register */
...
#define CAN_TXEFA_RESETVALUE        _U(0x00000000); /**< \brief (CAN_TXEFA reset_value) Tx Event FIFO Acknowledge */

#define CAN_TXEFA_EFAI_Pos          0            /**< \brief (CAN_TXEFA) Event FIFO Acknowledge Index */
#define CAN_TXEFA_EFAI_Msk          (_U(0x1F) << CAN_TXEFA_EFAI_Pos)
#define CAN_TXEFA_EFAI(value)       (CAN_TXEFA_EFAI_Msk & ((value) << CAN_TXEFA_EFAI_Pos))
#define CAN_TXEFA_MASK              _U(0x0000001F) /**< \brief (CAN_TXEFA) MASK Register */
...
#define CAN_RXBE_0_RESETVALUE       _U(0x00000000); /**< \brief (CAN_RXBE_0 reset_value) Rx Buffer Element 0 */

#define CAN_RXBE_0_ID_Pos           0            /**< \brief (CAN_RXBE_0) Identifier */
#define CAN_RXBE_0_ID_Msk           (_U(0x1FFFFFFF) << CAN_RXBE_0_ID_Pos)
...
#define CAN_RXBE_0_RTR              (_U(0x1) << CAN_RXBE_0_RTR_Pos)
#define CAN_RXBE_0_XTD_Pos          30           /**< \brief (CAN_RXBE_0) Extended Identifier */
#define CAN_RXBE_0_XTD              (_U(0x1) << CAN_RXBE_0_XTD_Pos)
#define CAN_RXBE_0_ESI_Pos          31           /**< \brief (CAN_RXBE_0) Error State Indicator */
#define CAN_RXBE_0_ESI              (_U(0x1) << CAN_RXBE_0_ESI_Pos)
#define CAN_RXBE_0_MASK             _U(0xFFFFFFFF) /**< \brief (CAN_RXBE_0) MASK Register */
...
#define CAN_RXBE_1_RESETVALUE       _U(0x00000000); /**< \brief (CAN_RXBE_1 reset_value) Rx Buffer Element 1 */

#define CAN_RXBE_1_RXTS_Pos         0            /**< \brief (CAN_RXBE_1) Rx Timestamp */
#define CAN_RXBE_1_RXTS_Msk         (_U(0xFFFF) << CAN_RXBE_1_RXTS_Pos)
...
#define CAN_RXBE_1_DLC_Msk          (_U(0xF) << CAN_RXBE_1_DLC_Pos)
...
#define CAN_RXBE_1_BRS              (_U(0x1) << CAN_RXBE_1_BRS_Pos)
#define CAN_RXBE_1_FDF_Pos          21           /**< \brief (CAN_RXBE_1) FD Format */
#define CAN_RXBE_1_FDF              (_U(0x1) << CAN_RXBE_1_FDF_Pos)
#define CAN_RXBE_1_FIDX_Pos         24           /**< \brief (CAN_RXBE_1) Filter Index */
#define CAN_RXBE_1_FIDX_Msk         (_U(0x7F) << CAN_RXBE_1_FIDX_Pos)
...
#define CAN_RXBE_1_ANMF             (_U(0x1) << CAN_RXBE_1_ANMF_Pos)
#define CAN_RXBE_1_MASK             _U(0xFF3FFFFF) /**< \brief (CAN_RXBE_1) MASK Register */
...
#define CAN_RXBE_DATA_RESETVALUE    _U(0x00000000); /**< \brief (CAN_RXBE_DATA reset_value) Rx Buffer Element Data */

#define CAN_RXBE_DATA_DB0_Pos       0            /**< \brief (CAN_RXBE_DATA) Data Byte 0 */
#define CAN_RXBE_DATA_DB0_Msk       (_U(0xFF) << CAN_RXBE_DATA_DB0_Pos)
...
#define CAN_RXBE_DATA_DB1_Msk       (_U(0xFF) << CAN_RXBE_DATA_DB1_Pos)
...
#define CAN_RXBE_DATA_DB2_Msk       (_U(0xFF) << CAN_RXBE_DATA_DB2_Pos)
...
#define CAN_RXBE_DATA_DB3_Msk       (_U(0xFF) << CAN_RXBE_DATA_DB3_Pos)
#define CAN_RXBE_DATA_DB3(value)    (CAN_RXBE_DATA_DB3_Msk & ((value) << CAN_RXBE_DATA_DB3_Pos))
#define CAN_RXBE_DATA_MASK          _U(0xFFFFFFFF) /**< \brief (CAN_RXBE_DATA) MASK Register */
...
#define CAN_RXF0E_0_RESETVALUE      _U(0x00000000); /**< \brief (CAN_RXF0E_0 reset_value) Rx FIFO 0 Element 0 */

#define CAN_RXF0E_0_ID_Pos          0            /**< \brief (CAN_RXF0E_0) Identifier */
#define CAN_RXF0E_0_ID_Msk          (_U(0x1FFFFFFF) << CAN_RXF0E_0_ID_Pos)
...
#define CAN_RXF0E_0_RTR             (_U(0x1) << CAN_RXF0E_0_RTR_Pos)
#define CAN_RXF0E_0_XTD_Pos         30           /**< \brief (CAN_RXF0E_0) Extended Identifier */
#define CAN_RXF0E_0_XTD             (_U(0x1) << CAN_RXF0E_0_XTD_Pos)
#define CAN_RXF0E_0_ESI_Pos         31           /**< \brief (CAN_RXF0E_0) Error State Indicator */
#define CAN_RXF0E_0_ESI             (_U(0x1) << CAN_RXF0E_0_ESI_Pos)
#define CAN_RXF0E_0_MASK            _U(0xFFFFFFFF) /**< \brief (CAN_RXF0E_0) MASK Register */
...
#define CAN_RXF0E_1_RESETVALUE      _U(0x00000000); /**< \brief (CAN_RXF0E_1 reset_value) Rx FIFO 0 Element 1 */

#define CAN_RXF0E_1_RXTS_Pos        0            /**< \brief (CAN_RXF0E_1) Rx Timestamp */
#define CAN_RXF0E_1_RXTS_Msk        (_U(0xFFFF) << CAN_RXF0E_1_RXTS_Pos)
...
#define CAN_RXF0E_1_DLC_Msk         (_U(0xF) << CAN_RXF0E_1_DLC_Pos)
...
#define CAN_RXF0E_1_BRS             (_U(0x1) << CAN_RXF0E_1_BRS_Pos)
#define CAN_RXF0E_1_FDF_Pos         21           /**< \brief (CAN_RXF0E_1) FD Format */
#define CAN_RXF0E_1_FDF             (_U(0x1) << CAN_RXF0E_1_FDF_Pos)
#define CAN_RXF0E_1_FIDX_Pos        24           /**< \brief (CAN_RXF0E_1) Filter Index */
#define CAN_RXF0E_1_FIDX_Msk        (_U(0x7F) << CAN_RXF0E_1_FIDX_Pos)
...
#define CAN_RXF0E_1_ANMF            (_U(0x1) << CAN_RXF0E_1_ANMF_Pos)
#define CAN_RXF0E_1_MASK            _U(0xFF3FFFFF) /**< \brief (CAN_RXF0E_1) MASK Register */
...
#define CAN_RXF0E_DATA_RESETVALUE   _U(0x00000000); /**< \brief (CAN_RXF0E_DATA reset_value) Rx FIFO 0 Element Data */

#define CAN_RXF0E_DATA_DB0_Pos      0            /**< \brief (CAN_RXF0E_DATA) Data Byte 0 */
#define CAN_RXF0E_DATA_DB0_Msk      (_U(0xFF) << CAN_RXF0E_DATA_DB0_Pos)
...
#define CAN_RXF0E_DATA_DB1_Msk      (_U(0xFF) << CAN_RXF0E_DATA_DB1_Pos)
...
#define CAN_RXF0E_DATA_DB2_Msk      (_U(0xFF) << CAN_RXF0E_DATA_DB2_Pos)
...
#define CAN_RXF0E_DATA_DB3_Msk      (_U(0xFF) << CAN_RXF0E_DATA_DB3_Pos)
#define CAN_RXF0E_DATA_DB3(value)   (CAN_RXF0E_DATA_DB3_Msk & ((value) << CAN_RXF0E_DATA_DB3_Pos))
#define CAN_RXF0E_DATA_MASK         _U(0xFFFFFFFF) /**< \brief (CAN_RXF0E_DATA) MASK Register */
...
#define CAN_RXF1E_0_RESETVALUE      _U(0x00000000); /**< \brief (CAN_RXF1E_0 reset_value) Rx FIFO 1 Element 0 */

#define CAN_RXF1E_0_ID_Pos          0            /**< \brief (CAN_RXF1E_0) Identifier */
#define CAN_RXF1E_0_ID_Msk          (_U(0x1FFFFFFF) << CAN_RXF1E_0_ID_Pos)
...
#define CAN_RXF1E_0_RTR             (_U(0x1) << CAN_RXF1E_0_RTR_Pos)
#define CAN_RXF1E_0_XTD_Pos         30           /**< \brief (CAN_RXF1E_0) Extended Identifier */
#define CAN_RXF1E_0_XTD             (_U(0x1) << CAN_RXF1E_0_XTD_Pos)
#define CAN_RXF1E_0_ESI_Pos         31           /**< \brief (CAN_RXF1E_0) Error State Indicator */
#define CAN_RXF1E_0_ESI             (_U(0x1) << CAN_RXF1E_0_ESI_Pos)
#define CAN_RXF1E_0_MASK            _U(0xFFFFFFFF) /**< \brief (CAN_RXF1E_0) MASK Register */
...
#define CAN_RXF1E_1_RESETVALUE      _U(0x00000000); /**< \brief (CAN_RXF1E_1 reset_value) Rx FIFO 1 Element 1 */

#define CAN_RXF1E_1_RXTS_Pos        0            /**< \brief (CAN_RXF1E_1) Rx Timestamp */
#define CAN_RXF1E_1_RXTS_Msk        (_U(0xFFFF) << CAN_RXF1E_1_RXTS_Pos)
...
#define CAN_RXF1E_1_DLC_Msk         (_U(0xF) << CAN_RXF1E_1_DLC_Pos)
...
#define CAN_RXF1E_1_BRS             (_U(0x1) << CAN_RXF1E_1_BRS_Pos)
#define CAN_RXF1E_1_FDF_Pos         21           /**< \brief (CAN_RXF1E_1) FD Format */
#define CAN_RXF1E_1_FDF             (_U(0x1) << CAN_RXF1E_1_FDF_Pos)
#define CAN_RXF1E_1_FIDX_Pos        24           /**< \brief (CAN_RXF1E_1) Filter Index */
#define CAN_RXF1E_1_FIDX_Msk        (_U(0x7F) << CAN_RXF1E_1_FIDX_Pos)
...
#define CAN_RXF1E_1_ANMF            (_U(0x1) << CAN_RXF1E_1_ANMF_Pos)
#define CAN_RXF1E_1_MASK            _U(0xFF3FFFFF) /**< \brief (CAN_RXF1E_1) MASK Register */
...
#define CAN_RXF1E_DATA_RESETVALUE   _U(0x00000000); /**< \brief (CAN_RXF1E_DATA reset_value) Rx FIFO 1 Element Data */

#define CAN_RXF1E_DATA_DB0_Pos      0            /**< \brief (CAN_RXF1E_DATA) Data Byte 0 */
#define CAN_RXF1E_DATA_DB0_Msk      (_U(0xFF) << CAN_RXF1E_DATA_DB0_Pos)
...
#define CAN_RXF1E_DATA_DB1_Msk      (_U(0xFF) << CAN_RXF1E_DATA_DB1_Pos)
...
#define CAN_RXF1E_DATA_DB2_Msk      (_U(0xFF) << CAN_RXF1E_DATA_DB2_Pos)
...
#define CAN_RXF1E_DATA_DB3_Msk      (_U(0xFF) << CAN_RXF1E_DATA_DB3_Pos)
#define CAN_RXF1E_DATA_DB3(value)   (CAN_RXF1E_DATA_DB3_Msk & ((value) << CAN_RXF1E_DATA_DB3_Pos))
#define CAN_RXF1E_DATA_MASK         _U(0xFFFFFFFF) /**< \brief (CAN_RXF1E_DATA) MASK Register */
...
#define CAN_SIDFE_0_RESETVALUE      _U(0x00000000); /**< \brief (CAN_SIDFE_0 reset_value) Standard Message ID Filter Element */

#define CAN_SIDFE_0_SFID2_Pos       0            /**< \brief (CAN_SIDFE_0) Standard Filter ID 2 */
#define CAN_SIDFE_0_SFID2_Msk       (_U(0x7FF) << CAN_SIDFE_0_SFID2_Pos)
...
#define CAN_SIDFE_0_SFID1_Msk       (_U(0x7FF) << CAN_SIDFE_0_SFID1_Pos)
...
#define CAN_SIDFE_0_SFEC_Msk        (_U(0x7) << CAN_SIDFE_0_SFEC_Pos)
#define CAN_SIDFE_0_SFEC(value)     (CAN_SIDFE_0_SFEC_Msk & ((value) << CAN_SIDFE_0_SFEC_Pos))
#define   CAN_SIDFE_0_SFEC_DISABLE_Val    _U(0x0)   /**< \brief (CAN_SIDFE_0) Disable filter element */
#define   CAN_SIDFE_0_SFEC_STF0M_Val      _U(0x1)   /**< \brief (CAN_SIDFE_0) Store in Rx FIFO 0 if filter match */
#define   CAN_SIDFE_0_SFEC_STF1M_Val      _U(0x2)   /**< \brief (CAN_SIDFE_0) Store in Rx FIFO 1 if filter match */
#define   CAN_SIDFE_0_SFEC_REJECT_Val     _U(0x3)   /**< \brief (CAN_SIDFE_0) Reject ID if filter match */
#define   CAN_SIDFE_0_SFEC_PRIORITY_Val   _U(0x4)   /**< \brief (CAN_SIDFE_0) Set priority if filter match */
#define   CAN_SIDFE_0_SFEC_PRIF0M_Val     _U(0x5)   /**< \brief (CAN_SIDFE_0) Set priority and store in FIFO 0 if filter match */
#define   CAN_SIDFE_0_SFEC_PRIF1M_Val     _U(0x6)   /**< \brief (CAN_SIDFE_0) Set priority and store in FIFO 1 if filter match */
#define   CAN_SIDFE_0_SFEC_STRXBUF_Val    _U(0x7)   /**< \brief (CAN_SIDFE_0) Store into Rx Buffer */
...
#define CAN_SIDFE_0_SFT_Msk         (_U(0x3) << CAN_SIDFE_0_SFT_Pos)
#define CAN_SIDFE_0_SFT(value)      (CAN_SIDFE_0_SFT_Msk & ((value) << CAN_SIDFE_0_SFT_Pos))
#define   CAN_SIDFE_0_SFT_RANGE_Val       _U(0x0)   /**< \brief (CAN_SIDFE_0) Range filter from SFID1 to SFID2 */
#define   CAN_SIDFE_0_SFT_DUAL_Val        _U(0x1)   /**< \brief (CAN_SIDFE_0) Dual ID filter for SFID1 or SFID2 */
#define   CAN_SIDFE_0_SFT_CLASSIC_Val     _U(0x2)   /**< \brief (CAN_SIDFE_0) Classic filter */
...
#define CAN_SIDFE_0_MASK            _U(0xFFFF07FF) /**< \brief (CAN_SIDFE_0) MASK Register */
...
#define CAN_TXBE_0_RESETVALUE       _U(0x00000000); /**< \brief (CAN_TXBE_0 reset_value) Tx Buffer Element 0 */

#define CAN_TXBE_0_ID_Pos           0            /**< \brief (CAN_TXBE_0) Identifier */
#define CAN_TXBE_0_ID_Msk           (_U(0x1FFFFFFF) << CAN_TXBE_0_ID_Pos)
...
#define CAN_TXBE_0_RTR              (_U(0x1) << CAN_TXBE_0_RTR_Pos)
#define CAN_TXBE_0_XTD_Pos          30           /**< \brief (CAN_TXBE_0) Extended Identifier */
#define CAN_TXBE_0_XTD              (_U(0x1) << CAN_TXBE_0_XTD_Pos)
#define CAN_TXBE_0_ESI_Pos          31           /**< \brief (CAN_TXBE_0) Error State Indicator */
#define CAN_TXBE_0_ESI              (_U(0x1) << CAN_TXBE_0_ESI_Pos)
#define CAN_TXBE_0_MASK             _U(0xFFFFFFFF) /**< \brief (CAN_TXBE_0) MASK Register */
...
#define CAN_TXBE_1_RESETVALUE       _U(0x00000000); /**< \brief (CAN_TXBE_1 reset_value) Tx Buffer Element 1 */

#define CAN_TXBE_1_DLC_Pos          16           /**< \brief (CAN_TXBE_1) Identifier */
#define CAN_TXBE_1_DLC_Msk          (_U(0xF) << CAN_TXBE_1_DLC_Pos)
...
#define CAN_TXBE_1_BRS              (_U(0x1) << CAN_TXBE_1_BRS_Pos)
#define CAN_TXBE_1_FDF_Pos          21           /**< \brief (CAN_TXBE_1) FD Format */
#define CAN_TXBE_1_FDF              (_U(0x1) << CAN_TXBE_1_FDF_Pos)
#define CAN_TXBE_1_EFC_Pos          23           /**< \brief (CAN_TXBE_1) Event FIFO Control */
#define CAN_TXBE_1_EFC              (_U(0x1) << CAN_TXBE_1_EFC_Pos)
#define CAN_TXBE_1_MM_Pos           24           /**< \brief (CAN_TXBE_1) Message Marker */
#define CAN_TXBE_1_MM_Msk           (_U(0xFF) << CAN_TXBE_1_MM_Pos)
#define CAN_TXBE_1_MM(value)        (CAN_TXBE_1_MM_Msk & ((value) << CAN_TXBE_1_MM_Pos))
#define CAN_TXBE_1_MASK             _U(0xFFBF0000) /**< \brief (CAN_TXBE_1) MASK Register */
...
#define CAN_TXBE_DATA_RESETVALUE    _U(0x00000000); /**< \brief (CAN_TXBE_DATA reset_value) Tx Buffer Element Data */

#define CAN_TXBE_DATA_DB0_Pos       0            /**< \brief (CAN_TXBE_DATA) Data Byte 0 */
#define CAN_TXBE_DATA_DB0_Msk       (_U(0xFF) << CAN_TXBE_DATA_DB0_Pos)
...
#define CAN_TXBE_DATA_DB1_Msk       (_U(0xFF) << CAN_TXBE_DATA_DB1_Pos)
...
#define CAN_TXBE_DATA_DB2_Msk       (_U(0xFF) << CAN_TXBE_DATA_DB2_Pos)
...
#define CAN_TXBE_DATA_DB3_Msk       (_U(0xFF) << CAN_TXBE_DATA_DB3_Pos)
#define CAN_TXBE_DATA_DB3(value)    (CAN_TXBE_DATA_DB3_Msk & ((value) << CAN_TXBE_DATA_DB3_Pos))
#define CAN_TXBE_DATA_MASK          _U(0xFFFFFFFF) /**< \brief (CAN_TXBE_DATA) MASK Register */
...
#define CAN_TXEFE_0_RESETVALUE      _U(0x00000000); /**< \brief (CAN_TXEFE_0 reset_value) Tx Event FIFO Element 0 */

#define CAN_TXEFE_0_ID_Pos          0            /**< \brief (CAN_TXEFE_0) Identifier */
#define CAN_TXEFE_0_ID_Msk          (_U(0x1FFFFFFF) << CAN_TXEFE_0_ID_Pos)
...
#define CAN_TXEFE_0_RTR             (_U(0x1) << CAN_TXEFE_0_RTR_Pos)
#define CAN_TXEFE_0_XTD_Pos         30           /**< \brief (CAN_TXEFE_0) Extended Indentifier */
#define CAN_TXEFE_0_XTD             (_U(0x1) << CAN_TXEFE_0_XTD_Pos)
#define CAN_TXEFE_0_ESI_Pos         31           /**< \brief (CAN_TXEFE_0) Error State Indicator */
#define CAN_TXEFE_0_ESI             (_U(0x1) << CAN_TXEFE_0_ESI_Pos)
#define CAN_TXEFE_0_MASK            _U(0xFFFFFFFF) /**< \brief (CAN_TXEFE_0) MASK Register */
...
#define CAN_TXEFE_1_RESETVALUE      _U(0x00000000); /**< \brief (CAN_TXEFE_1 reset_value) Tx Event FIFO Element 1 */

#define CAN_TXEFE_1_TXTS_Pos        0            /**< \brief (CAN_TXEFE_1) Tx Timestamp */
#define CAN_TXEFE_1_TXTS_Msk        (_U(0xFFFF) << CAN_TXEFE_1_TXTS_Pos)
...
#define CAN_TXEFE_1_DLC_Msk         (_U(0xF) << CAN_TXEFE_1_DLC_Pos)
...
#define CAN_TXEFE_1_BRS             (_U(0x1) << CAN_TXEFE_1_BRS_Pos)
#define CAN_TXEFE_1_FDF_Pos         21           /**< \brief (CAN_TXEFE_1) FD Format */
#define CAN_TXEFE_1_FDF             (_U(0x1) << CAN_TXEFE_1_FDF_Pos)
#define CAN_TXEFE_1_ET_Pos          22           /**< \brief (CAN_TXEFE_1) Event Type */
#define CAN_TXEFE_1_ET_Msk          (_U(0x3) << CAN_TXEFE_1_ET_Pos)
#define CAN_TXEFE_1_ET(value)       (CAN_TXEFE_1_ET_Msk & ((value) << CAN_TXEFE_1_ET_Pos))
#define   CAN_TXEFE_1_ET_TXE_Val          _U(0x1)   /**< \brief (CAN_TXEFE_1) Tx event */
#define   CAN_TXEFE_1_ET_TXC_Val          _U(0x2)   /**< \brief (CAN_TXEFE_1) Transmission in spite of cancellation */
...
#define CAN_TXEFE_1_MM_Msk          (_U(0xFF) << CAN_TXEFE_1_MM_Pos)
#define CAN_TXEFE_1_MM(value)       (CAN_TXEFE_1_MM_Msk & ((value) << CAN_TXEFE_1_MM_Pos))
#define CAN_TXEFE_1_MASK            _U(0xFFFFFFFF) /**< \brief (CAN_TXEFE_1) MASK Register */
...
#define CAN_XIDFE_0_RESETVALUE      _U(0x00000000); /**< \brief (CAN_XIDFE_0 reset_value) Extended Message ID Filter Element 0 */

#define CAN_XIDFE_0_EFID1_Pos       0            /**< \brief (CAN_XIDFE_0) Extended Filter ID 1 */
#define CAN_XIDFE_0_EFID1_Msk       (_U(0x1FFFFFFF) << CAN_XIDFE_0_EFID1_Pos)
...
#define CAN_XIDFE_0_EFEC_Msk        (_U(0x7) << CAN_XIDFE_0_EFEC_Pos)
#define CAN_XIDFE_0_EFEC(value)     (CAN_XIDFE_0_EFEC_Msk & ((value) << CAN_XIDFE_0_EFEC_Pos))
#define   CAN_XIDFE_0_EFEC_DISABLE_Val    _U(0x0)   /**< \brief (CAN_XIDFE_0) Disable filter element */
#define   CAN_XIDFE_0_EFEC_STF0M_Val      _U(0x1)   /**< \brief (CAN_XIDFE_0) Store in Rx FIFO 0 if filter match */
#define   CAN_XIDFE_0_EFEC_STF1M_Val      _U(0x2)   /**< \brief (CAN_XIDFE_0) Store in Rx FIFO 1 if filter match */
#define   CAN_XIDFE_0_EFEC_REJECT_Val     _U(0x3)   /**< \brief (CAN_XIDFE_0) Reject ID if filter match */
#define   CAN_XIDFE_0_EFEC_PRIORITY_Val   _U(0x4)   /**< \brief (CAN_XIDFE_0) Set priority if filter match */
#define   CAN_XIDFE_0_EFEC_PRIF0M_Val     _U(0x5)   /**< \brief (CAN_XIDFE_0) Set priority and store in FIFO 0 if filter match */
#define   CAN_XIDFE_0_EFEC_PRIF1M_Val     _U(0x6)   /**< \brief (CAN_XIDFE_0) Set priority and store in FIFO 1 if filter match */
#define   CAN_XIDFE_0_EFEC_STRXBUF_Val    _U(0x7)   /**< \brief (CAN_XIDFE_0) Store into Rx Buffer */
...
#define CAN_XIDFE_0_MASK            _U(0xFFFFFFFF) /**< \brief (CAN_XIDFE_0) MASK Register */
...
#define CAN_XIDFE_1_RESETVALUE      _U(0x00000000); /**< \brief (CAN_XIDFE_1 reset_value) Extended Message ID Filter Element 1 */

#define CAN_XIDFE_1_EFID2_Pos       0            /**< \brief (CAN_XIDFE_1) Extended Filter ID 2 */
#define CAN_XIDFE_1_EFID2_Msk       (_U(0x1FFFFFFF) << CAN_XIDFE_1_EFID2_Pos)
...
#define CAN_XIDFE_1_EFT_Msk         (_U(0x3) << CAN_XIDFE_1_EFT_Pos)
#define CAN_XIDFE_1_EFT(value)      (CAN_XIDFE_1_EFT_Msk & ((value) << CAN_XIDFE_1_EFT_Pos))
#define   CAN_XIDFE_1_EFT_RANGEM_Val      _U(0x0)   /**< \brief (CAN_XIDFE_1) Range filter from EFID1 to EFID2 */
#define   CAN_XIDFE_1_EFT_DUAL_Val        _U(0x1)   /**< \brief (CAN_XIDFE_1) Dual ID filter for EFID1 or EFID2 */
#define   CAN_XIDFE_1_EFT_CLASSIC_Val     _U(0x2)   /**< \brief (CAN_XIDFE_1) Classic filter */
#define   CAN_XIDFE_1_EFT_RANGE_Val       _U(0x3)   /**< \brief (CAN_XIDFE_1) Range filter from EFID1 to EFID2 with no XIDAM mask */
...
#define CAN_XIDFE_1_MASK            _U(0xDFFFFFFF) /**< \brief (CAN_XIDFE_1) MASK Register */
