...
#define ADC_CTRLA_MASK              _U(0xE3)     /**< \brief (ADC_CTRLA) MASK Register */
...
#define   ADC_REFCTRL_REFSEL_DAC_Val      _U(0x4)   /**< \brief (ADC_REFCTRL) DAC */
#define   ADC_REFCTRL_REFSEL_INTVCC2_Val  _U(0x5)   /**< \brief (ADC_REFCTRL) VDDANA */
...
#define ADC_CTRLC_R2R               (_U(0x1) << ADC_CTRLC_R2R_Pos)
...
#define ADC_CTRLC_DUALSEL_Msk       (_U(0x3) << ADC_CTRLC_DUALSEL_Pos)
#define ADC_CTRLC_DUALSEL(value)    (ADC_CTRLC_DUALSEL_Msk & ((value) << ADC_CTRLC_DUALSEL_Pos))
#define   ADC_CTRLC_DUALSEL_BOTH_Val      _U(0x0)   /**< \brief (ADC_CTRLC) Start event or software trigger will start a conversion on both ADCs */
#define   ADC_CTRLC_DUALSEL_INTERLEAVE_Val _U(0x1)   /**< \brief (ADC_CTRLC) START event or software trigger will alternatingly start a conversion on ADC0 and ADC1 */
...
#define ADC_CTRLC_MASK              _U(0x37BF)   /**< \brief (ADC_CTRLC) MASK Register */
