...
#define SDADC_CTRLA_RESETVALUE      _U(0x00);    /**< \brief (SDADC_CTRLA reset_value) Control A */

#define SDADC_CTRLA_SWRST_Pos       0            /**< \brief (SDADC_CTRLA) Software Reset */
#define SDADC_CTRLA_SWRST           (_U(0x1) << SDADC_CTRLA_SWRST_Pos)
#define SDADC_CTRLA_ENABLE_Pos      1            /**< \brief (SDADC_CTRLA) Enable */
#define SDADC_CTRLA_ENABLE          (_U(0x1) << SDADC_CTRLA_ENABLE_Pos)
#define SDADC_CTRLA_RUNSTDBY_Pos    6            /**< \brief (SDADC_CTRLA) Run during Standby */
#define SDADC_CTRLA_RUNSTDBY        (_U(0x1) << SDADC_CTRLA_RUNSTDBY_Pos)
#define SDADC_CTRLA_ONDEMAND_Pos    7            /**< \brief (SDADC_CTRLA) On Demand Control */
#define SDADC_CTRLA_ONDEMAND        (_U(0x1) << SDADC_CTRLA_ONDEMAND_Pos)
#define SDADC_CTRLA_MASK            _U(0xC3)     /**< \brief (SDADC_CTRLA) MASK Register */
...
#define SDADC_REFCTRL_RESETVALUE    _U(0x00);    /**< \brief (SDADC_REFCTRL reset_value) Reference Control */

#define SDADC_REFCTRL_REFSEL_Pos    0            /**< \brief (SDADC_REFCTRL) Reference Selection */
#define SDADC_REFCTRL_REFSEL_Msk    (_U(0x3) << SDADC_REFCTRL_REFSEL_Pos)
#define SDADC_REFCTRL_REFSEL(value) (SDADC_REFCTRL_REFSEL_Msk & ((value) << SDADC_REFCTRL_REFSEL_Pos))
#define   SDADC_REFCTRL_REFSEL_INTREF_Val _U(0x0)   /**< \brief (SDADC_REFCTRL) Internal Bandgap Reference */
#define   SDADC_REFCTRL_REFSEL_AREFB_Val  _U(0x1)   /**< \brief (SDADC_REFCTRL) External Reference */
#define   SDADC_REFCTRL_REFSEL_DAC_Val    _U(0x2)   /**< \brief (SDADC_REFCTRL) Internal DAC Output */
#define   SDADC_REFCTRL_REFSEL_INTVCC_Val _U(0x3)   /**< \brief (SDADC_REFCTRL) VDDANA */
...
#define SDADC_REFCTRL_REFRANGE_Msk  (_U(0x3) << SDADC_REFCTRL_REFRANGE_Pos)
...
#define SDADC_REFCTRL_ONREFBUF      (_U(0x1) << SDADC_REFCTRL_ONREFBUF_Pos)
#define SDADC_REFCTRL_MASK          _U(0xB3)     /**< \brief (SDADC_REFCTRL) MASK Register */
...
#define SDADC_CTRLB_RESETVALUE      _U(0x2000);  /**< \brief (SDADC_CTRLB reset_value) Control B */

#define SDADC_CTRLB_PRESCALER_Pos   0            /**< \brief (SDADC_CTRLB) Prescaler Configuration */
#define SDADC_CTRLB_PRESCALER_Msk   (_U(0xFF) << SDADC_CTRLB_PRESCALER_Pos)
...
#define SDADC_CTRLB_OSR_Msk         (_U(0x7) << SDADC_CTRLB_OSR_Pos)
...
#define SDADC_CTRLB_SKPCNT_Msk      (_U(0xF) << SDADC_CTRLB_SKPCNT_Pos)
#define SDADC_CTRLB_SKPCNT(value)   (SDADC_CTRLB_SKPCNT_Msk & ((value) << SDADC_CTRLB_SKPCNT_Pos))
#define SDADC_CTRLB_MASK            _U(0xF7FF)   /**< \brief (SDADC_CTRLB) MASK Register */
...
#define SDADC_EVCTRL_RESETVALUE     _U(0x00);    /**< \brief (SDADC_EVCTRL reset_value) Event Control */

#define SDADC_EVCTRL_FLUSHEI_Pos    0            /**< \brief (SDADC_EVCTRL) Flush Event Input Enable */
#define SDADC_EVCTRL_FLUSHEI        (_U(0x1) << SDADC_EVCTRL_FLUSHEI_Pos)
#define SDADC_EVCTRL_STARTEI_Pos    1            /**< \brief (SDADC_EVCTRL) Start Conversion Event Input Enable */
#define SDADC_EVCTRL_STARTEI        (_U(0x1) << SDADC_EVCTRL_STARTEI_Pos)
#define SDADC_EVCTRL_FLUSHINV_Pos   2            /**< \brief (SDADC_EVCTRL) Flush Event Invert Enable */
#define SDADC_EVCTRL_FLUSHINV       (_U(0x1) << SDADC_EVCTRL_FLUSHINV_Pos)
#define SDADC_EVCTRL_STARTINV_Pos   3            /**< \brief (SDADC_EVCTRL) Satrt Event Invert Enable */
#define SDADC_EVCTRL_STARTINV       (_U(0x1) << SDADC_EVCTRL_STARTINV_Pos)
#define SDADC_EVCTRL_RESRDYEO_Pos   4            /**< \brief (SDADC_EVCTRL) Result Ready Event Out */
#define SDADC_EVCTRL_RESRDYEO       (_U(0x1) << SDADC_EVCTRL_RESRDYEO_Pos)
#define SDADC_EVCTRL_WINMONEO_Pos   5            /**< \brief (SDADC_EVCTRL) Window Monitor Event Out */
#define SDADC_EVCTRL_WINMONEO       (_U(0x1) << SDADC_EVCTRL_WINMONEO_Pos)
#define SDADC_EVCTRL_MASK           _U(0x3F)     /**< \brief (SDADC_EVCTRL) MASK Register */
...
#define SDADC_INTENCLR_RESETVALUE   _U(0x00);    /**< \brief (SDADC_INTENCLR reset_value) Interrupt Enable Clear */

#define SDADC_INTENCLR_RESRDY_Pos   0            /**< \brief (SDADC_INTENCLR) Result Ready Interrupt Disable */
#define SDADC_INTENCLR_RESRDY       (_U(0x1) << SDADC_INTENCLR_RESRDY_Pos)
#define SDADC_INTENCLR_OVERRUN_Pos  1            /**< \brief (SDADC_INTENCLR) Overrun Interrupt Disable */
#define SDADC_INTENCLR_OVERRUN      (_U(0x1) << SDADC_INTENCLR_OVERRUN_Pos)
#define SDADC_INTENCLR_WINMON_Pos   2            /**< \brief (SDADC_INTENCLR) Window Monitor Interrupt Disable */
#define SDADC_INTENCLR_WINMON       (_U(0x1) << SDADC_INTENCLR_WINMON_Pos)
#define SDADC_INTENCLR_MASK         _U(0x07)     /**< \brief (SDADC_INTENCLR) MASK Register */
...
#define SDADC_INTENSET_RESETVALUE   _U(0x00);    /**< \brief (SDADC_INTENSET reset_value) Interrupt Enable Set */

#define SDADC_INTENSET_RESRDY_Pos   0            /**< \brief (SDADC_INTENSET) Result Ready Interrupt Enable */
#define SDADC_INTENSET_RESRDY       (_U(0x1) << SDADC_INTENSET_RESRDY_Pos)
#define SDADC_INTENSET_OVERRUN_Pos  1            /**< \brief (SDADC_INTENSET) Overrun Interrupt Enable */
#define SDADC_INTENSET_OVERRUN      (_U(0x1) << SDADC_INTENSET_OVERRUN_Pos)
#define SDADC_INTENSET_WINMON_Pos   2            /**< \brief (SDADC_INTENSET) Window Monitor Interrupt Enable */
#define SDADC_INTENSET_WINMON       (_U(0x1) << SDADC_INTENSET_WINMON_Pos)
#define SDADC_INTENSET_MASK         _U(0x07)     /**< \brief (SDADC_INTENSET) MASK Register */
...
#define SDADC_INTFLAG_RESETVALUE    _U(0x00);    /**< \brief (SDADC_INTFLAG reset_value) Interrupt Flag Status and Clear */

#define SDADC_INTFLAG_RESRDY_Pos    0            /**< \brief (SDADC_INTFLAG) Result Ready Interrupt Flag */
#define SDADC_INTFLAG_RESRDY        (_U(0x1) << SDADC_INTFLAG_RESRDY_Pos)
#define SDADC_INTFLAG_OVERRUN_Pos   1            /**< \brief (SDADC_INTFLAG) Overrun Interrupt Flag */
#define SDADC_INTFLAG_OVERRUN       (_U(0x1) << SDADC_INTFLAG_OVERRUN_Pos)
#define SDADC_INTFLAG_WINMON_Pos    2            /**< \brief (SDADC_INTFLAG) Window Monitor Interrupt Flag */
#define SDADC_INTFLAG_WINMON        (_U(0x1) << SDADC_INTFLAG_WINMON_Pos)
#define SDADC_INTFLAG_MASK          _U(0x07)     /**< \brief (SDADC_INTFLAG) MASK Register */
...
#define SDADC_SEQSTATUS_RESETVALUE  _U(0x00);    /**< \brief (SDADC_SEQSTATUS reset_value) Sequence Status */

#define SDADC_SEQSTATUS_SEQSTATE_Pos 0            /**< \brief (SDADC_SEQSTATUS) Sequence State */
#define SDADC_SEQSTATUS_SEQSTATE_Msk (_U(0xF) << SDADC_SEQSTATUS_SEQSTATE_Pos)
...
#define SDADC_SEQSTATUS_SEQBUSY     (_U(0x1) << SDADC_SEQSTATUS_SEQBUSY_Pos)
#define SDADC_SEQSTATUS_MASK        _U(0x8F)     /**< \brief (SDADC_SEQSTATUS) MASK Register */
...
#define SDADC_INPUTCTRL_RESETVALUE  _U(0x00);    /**< \brief (SDADC_INPUTCTRL reset_value) Input Control */

#define SDADC_INPUTCTRL_MUXSEL_Pos  0            /**< \brief (SDADC_INPUTCTRL) SDADC Input Selection */
#define SDADC_INPUTCTRL_MUXSEL_Msk  (_U(0xF) << SDADC_INPUTCTRL_MUXSEL_Pos)
#define SDADC_INPUTCTRL_MUXSEL(value) (SDADC_INPUTCTRL_MUXSEL_Msk & ((value) << SDADC_INPUTCTRL_MUXSEL_Pos))
#define   SDADC_INPUTCTRL_MUXSEL_AIN0_Val _U(0x0)   /**< \brief (SDADC_INPUTCTRL) SDADC AIN0 Pin */
#define   SDADC_INPUTCTRL_MUXSEL_AIN1_Val _U(0x1)   /**< \brief (SDADC_INPUTCTRL) SDADC AIN1 Pin */
#define   SDADC_INPUTCTRL_MUXSEL_AIN2_Val _U(0x2)   /**< \brief (SDADC_INPUTCTRL) SDADC AIN2 Pin */
...
#define SDADC_INPUTCTRL_MASK        _U(0x0F)     /**< \brief (SDADC_INPUTCTRL) MASK Register */
...
#define SDADC_CTRLC_RESETVALUE      _U(0x00);    /**< \brief (SDADC_CTRLC reset_value) Control C */

#define SDADC_CTRLC_FREERUN_Pos     0            /**< \brief (SDADC_CTRLC) Free Running Mode */
#define SDADC_CTRLC_FREERUN         (_U(0x1) << SDADC_CTRLC_FREERUN_Pos)
#define SDADC_CTRLC_MASK            _U(0x01)     /**< \brief (SDADC_CTRLC) MASK Register */
...
#define SDADC_WINCTRL_RESETVALUE    _U(0x00);    /**< \brief (SDADC_WINCTRL reset_value) Window Monitor Control */

#define SDADC_WINCTRL_WINMODE_Pos   0            /**< \brief (SDADC_WINCTRL) Window Monitor Mode */
#define SDADC_WINCTRL_WINMODE_Msk   (_U(0x7) << SDADC_WINCTRL_WINMODE_Pos)
#define SDADC_WINCTRL_WINMODE(value) (SDADC_WINCTRL_WINMODE_Msk & ((value) << SDADC_WINCTRL_WINMODE_Pos))
#define SDADC_WINCTRL_MASK          _U(0x07)     /**< \brief (SDADC_WINCTRL) MASK Register */
...
#define SDADC_WINLT_RESETVALUE      _U(0x00000000); /**< \brief (SDADC_WINLT reset_value) Window Monitor Lower Threshold */

#define SDADC_WINLT_WINLT_Pos       0            /**< \brief (SDADC_WINLT) Window Lower Threshold */
#define SDADC_WINLT_WINLT_Msk       (_U(0xFFFFFF) << SDADC_WINLT_WINLT_Pos)
#define SDADC_WINLT_WINLT(value)    (SDADC_WINLT_WINLT_Msk & ((value) << SDADC_WINLT_WINLT_Pos))
#define SDADC_WINLT_MASK            _U(0x00FFFFFF) /**< \brief (SDADC_WINLT) MASK Register */
...
#define SDADC_WINUT_RESETVALUE      _U(0x00000000); /**< \brief (SDADC_WINUT reset_value) Window Monitor Upper Threshold */

#define SDADC_WINUT_WINUT_Pos       0            /**< \brief (SDADC_WINUT) Window Upper Threshold */
#define SDADC_WINUT_WINUT_Msk       (_U(0xFFFFFF) << SDADC_WINUT_WINUT_Pos)
#define SDADC_WINUT_WINUT(value)    (SDADC_WINUT_WINUT_Msk & ((value) << SDADC_WINUT_WINUT_Pos))
#define SDADC_WINUT_MASK            _U(0x00FFFFFF) /**< \brief (SDADC_WINUT) MASK Register */
...
#define SDADC_OFFSETCORR_RESETVALUE _U(0x00000000); /**< \brief (SDADC_OFFSETCORR reset_value) Offset Correction */

#define SDADC_OFFSETCORR_OFFSETCORR_Pos 0            /**< \brief (SDADC_OFFSETCORR) Offset Correction Value */
#define SDADC_OFFSETCORR_OFFSETCORR_Msk (_U(0xFFFFFF) << SDADC_OFFSETCORR_OFFSETCORR_Pos)
#define SDADC_OFFSETCORR_OFFSETCORR(value) (SDADC_OFFSETCORR_OFFSETCORR_Msk & ((value) << SDADC_OFFSETCORR_OFFSETCORR_Pos))
#define SDADC_OFFSETCORR_MASK       _U(0x00FFFFFF) /**< \brief (SDADC_OFFSETCORR) MASK Register */
...
#define SDADC_GAINCORR_RESETVALUE   _U(0x0001);  /**< \brief (SDADC_GAINCORR reset_value) Gain Correction */

#define SDADC_GAINCORR_GAINCORR_Pos 0            /**< \brief (SDADC_GAINCORR) Gain Correction Value */
#define SDADC_GAINCORR_GAINCORR_Msk (_U(0x3FFF) << SDADC_GAINCORR_GAINCORR_Pos)
#define SDADC_GAINCORR_GAINCORR(value) (SDADC_GAINCORR_GAINCORR_Msk & ((value) << SDADC_GAINCORR_GAINCORR_Pos))
#define SDADC_GAINCORR_MASK         _U(0x3FFF)   /**< \brief (SDADC_GAINCORR) MASK Register */
...
#define SDADC_SHIFTCORR_RESETVALUE  _U(0x00);    /**< \brief (SDADC_SHIFTCORR reset_value) Shift Correction */

#define SDADC_SHIFTCORR_SHIFTCORR_Pos 0            /**< \brief (SDADC_SHIFTCORR) Shift Correction Value */
#define SDADC_SHIFTCORR_SHIFTCORR_Msk (_U(0xF) << SDADC_SHIFTCORR_SHIFTCORR_Pos)
#define SDADC_SHIFTCORR_SHIFTCORR(value) (SDADC_SHIFTCORR_SHIFTCORR_Msk & ((value) << SDADC_SHIFTCORR_SHIFTCORR_Pos))
#define SDADC_SHIFTCORR_MASK        _U(0x0F)     /**< \brief (SDADC_SHIFTCORR) MASK Register */
...
#define SDADC_SWTRIG_RESETVALUE     _U(0x00);    /**< \brief (SDADC_SWTRIG reset_value) Software Trigger */

#define SDADC_SWTRIG_FLUSH_Pos      0            /**< \brief (SDADC_SWTRIG) SDADC Flush */
#define SDADC_SWTRIG_FLUSH          (_U(0x1) << SDADC_SWTRIG_FLUSH_Pos)
#define SDADC_SWTRIG_START_Pos      1            /**< \brief (SDADC_SWTRIG) Start SDADC Conversion */
#define SDADC_SWTRIG_START          (_U(0x1) << SDADC_SWTRIG_START_Pos)
#define SDADC_SWTRIG_MASK           _U(0x03)     /**< \brief (SDADC_SWTRIG) MASK Register */
...
#define SDADC_RESULT_RESETVALUE     _U(0x00000000); /**< \brief (SDADC_RESULT reset_value) Result */

#define SDADC_RESULT_RESULT_Pos     0            /**< \brief (SDADC_RESULT) Result Value */
#define SDADC_RESULT_RESULT_Msk     (_U(0xFFFFFF) << SDADC_RESULT_RESULT_Pos)
...
#define SDADC_RESULT_RESERVED_Msk   (_U(0xFF) << SDADC_RESULT_RESERVED_Pos)
#define SDADC_RESULT_RESERVED(value) (SDADC_RESULT_RESERVED_Msk & ((value) << SDADC_RESULT_RESERVED_Pos))
#define SDADC_RESULT_MASK           _U(0xFFFFFFFF) /**< \brief (SDADC_RESULT) MASK Register */
...
#define SDADC_SEQCTRL_RESETVALUE    _U(0x00);    /**< \brief (SDADC_SEQCTRL reset_value) Sequence Control */

#define SDADC_SEQCTRL_SEQEN_Pos     0            /**< \brief (SDADC_SEQCTRL) Enable Positive Input in the Sequence */
#define SDADC_SEQCTRL_SEQEN_Msk     (_U(0x7) << SDADC_SEQCTRL_SEQEN_Pos)
#define SDADC_SEQCTRL_SEQEN(value)  (SDADC_SEQCTRL_SEQEN_Msk & ((value) << SDADC_SEQCTRL_SEQEN_Pos))
#define SDADC_SEQCTRL_MASK          _U(0x07)     /**< \brief (SDADC_SEQCTRL) MASK Register */
...
#define SDADC_ANACTRL_RESETVALUE    _U(0x00);    /**< \brief (SDADC_ANACTRL reset_value) Analog Control */

#define SDADC_ANACTRL_CTRSDADC_Pos  0            /**< \brief (SDADC_ANACTRL) SDADC Control */
#define SDADC_ANACTRL_CTRSDADC_Msk  (_U(0x3F) << SDADC_ANACTRL_CTRSDADC_Pos)
...
#define SDADC_ANACTRL_ONCHOP        (_U(0x1) << SDADC_ANACTRL_ONCHOP_Pos)
#define SDADC_ANACTRL_BUFTEST_Pos   7            /**< \brief (SDADC_ANACTRL) BUFTEST */
#define SDADC_ANACTRL_BUFTEST       (_U(0x1) << SDADC_ANACTRL_BUFTEST_Pos)
#define SDADC_ANACTRL_MASK          _U(0xFF)     /**< \brief (SDADC_ANACTRL) MASK Register */
...
#define SDADC_DBGCTRL_RESETVALUE    _U(0x00);    /**< \brief (SDADC_DBGCTRL reset_value) Debug Control */

#define SDADC_DBGCTRL_DBGRUN_Pos    0            /**< \brief (SDADC_DBGCTRL) Debug Run */
#define SDADC_DBGCTRL_DBGRUN        (_U(0x1) << SDADC_DBGCTRL_DBGRUN_Pos)
#define SDADC_DBGCTRL_MASK          _U(0x01)     /**< \brief (SDADC_DBGCTRL) MASK Register */
