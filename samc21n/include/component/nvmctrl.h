...
#define NVMCTRL_CTRLB_CACHEDIS_Msk  (_U(0x3) << NVMCTRL_CTRLB_CACHEDIS_Pos)
#define NVMCTRL_CTRLB_CACHEDIS(value) (NVMCTRL_CTRLB_CACHEDIS_Msk & ((value) << NVMCTRL_CTRLB_CACHEDIS_Pos))
#define NVMCTRL_CTRLB_MASK          _U(0x000F039E) /**< \brief (NVMCTRL_CTRLB) MASK Register */
...
#define NVMCTRL_LOCK_RESETVALUE     _U(0x0000);  /**< \brief (NVMCTRL_LOCK reset_value) Lock Section */
...
#define NVMCTRL_PBLDATA0_RESETVALUE _U(0x00000000); /**< \brief (NVMCTRL_PBLDATA0 reset_value) Page Buffer Load Data 0 */
#define NVMCTRL_PBLDATA0_MASK       _U(0xFFFFFFFF) /**< \brief (NVMCTRL_PBLDATA0) MASK Register */
...
#define NVMCTRL_PBLDATA1_RESETVALUE _U(0x00000000); /**< \brief (NVMCTRL_PBLDATA1 reset_value) Page Buffer Load Data 1 */
#define NVMCTRL_PBLDATA1_MASK       _U(0xFFFFFFFF) /**< \brief (NVMCTRL_PBLDATA1) MASK Register */
...
#define FUSES_BODCOREUSERLEVEL_Msk  (_U(0x3F) << FUSES_BODCOREUSERLEVEL_Pos)
...
#define FUSES_BODCORE_ACTION_Msk    (_U(0x3) << FUSES_BODCORE_ACTION_Pos)
...
#define FUSES_BODVDD_ACTION_Msk     (_U(0x3) << FUSES_BODVDD_ACTION_Pos)
...
#define FUSES_BODVDD_DIS_Msk        (_U(0x1) << FUSES_BODVDD_DIS_Pos)

#define FUSES_BODVDD_HYST_ADDR      (NVMCTRL_USER + 4)
#define FUSES_BODVDD_HYST_Pos       9            /**< \brief (NVMCTRL_USER) BODVDD Hysterisis */
#define FUSES_BODVDD_HYST_Msk       (_U(0x1) << FUSES_BODVDD_HYST_Pos)
...
#define NVMCTRL_FUSES_DUMMY2_Pos    31           /**< \brief (NVMCTRL_OTP3) Dummy for OTP row 3 */
#define NVMCTRL_FUSES_DUMMY2_Msk    (_U(0x1) << NVMCTRL_FUSES_DUMMY2_Pos)
...
#define TSENS_FUSES_FCAL_Msk        (_U(0x3F) << TSENS_FUSES_FCAL_Pos)
...
#define TSENS_FUSES_GAIN_0_Msk      (_U(0xFFFFF) << TSENS_FUSES_GAIN_0_Pos)
...
#define TSENS_FUSES_GAIN_1_Msk      (_U(0xF) << TSENS_FUSES_GAIN_1_Pos)
...
#define TSENS_FUSES_OFFSET_Msk      (_U(0xFFFFFF) << TSENS_FUSES_OFFSET_Pos)
...
#define TSENS_FUSES_TCAL_Msk        (_U(0x3F) << TSENS_FUSES_TCAL_Pos)
