...
#define SERCOM_USART_CTRLC_MASK     _U(0x00000F07) /**< \brief (SERCOM_USART_CTRLC) MASK Register */
...
#define SERCOM_USART_STATUS_MASK    _U(0x007F)   /**< \brief (SERCOM_USART_STATUS) MASK Register */
