...
#define DAC_CTRLA_MASK              _U(0x43)     /**< \brief (DAC_CTRLA) MASK Register */
...
#define DAC_CTRLB_DITHER            (_U(0x1) << DAC_CTRLB_DITHER_Pos)
...
#define DAC_CTRLB_MASK              _U(0xEF)     /**< \brief (DAC_CTRLB) MASK Register */
...
#define DAC_EVCTRL_INVEI            (_U(0x1) << DAC_EVCTRL_INVEI_Pos)
#define DAC_EVCTRL_MASK             _U(0x07)     /**< \brief (DAC_EVCTRL) MASK Register */
...
#define DAC_INTENCLR_MASK           _U(0x03)     /**< \brief (DAC_INTENCLR) MASK Register */
...
#define DAC_INTENSET_MASK           _U(0x03)     /**< \brief (DAC_INTENSET) MASK Register */
...
#define DAC_INTFLAG_MASK            _U(0x03)     /**< \brief (DAC_INTFLAG) MASK Register */
...
#define DAC_STATUS_READY            (_U(0x1) << DAC_STATUS_READY_Pos)
#define DAC_STATUS_MASK             _U(0x01)     /**< \brief (DAC_STATUS) MASK Register */
...
#define DAC_SYNCBUSY_DATA           (_U(0x1) << DAC_SYNCBUSY_DATA_Pos)
#define DAC_SYNCBUSY_DATABUF_Pos    3            /**< \brief (DAC_SYNCBUSY) Data Buffer */
#define DAC_SYNCBUSY_DATABUF        (_U(0x1) << DAC_SYNCBUSY_DATABUF_Pos)
#define DAC_SYNCBUSY_MASK           _U(0x0000000F) /**< \brief (DAC_SYNCBUSY) MASK Register */
