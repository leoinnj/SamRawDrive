...
#define PAC_INTFLAGAHB_DIVAS        (_U(0x1) << PAC_INTFLAGAHB_DIVAS_Pos)
#define PAC_INTFLAGAHB_HPB3_Pos     8            /**< \brief (PAC_INTFLAGAHB) HPB3 */
#define PAC_INTFLAGAHB_HPB3         (_U(0x1) << PAC_INTFLAGAHB_HPB3_Pos)
#define PAC_INTFLAGAHB_MASK         _U(0x000001FF) /**< \brief (PAC_INTFLAGAHB) MASK Register */
...
#define PAC_INTFLAGA_TSENS          (_U(0x1) << PAC_INTFLAGA_TSENS_Pos)
#define PAC_INTFLAGA_MASK           _U(0x00001FFF) /**< \brief (PAC_INTFLAGA) MASK Register */
...
#define PAC_INTFLAGB_HMATRIXHS      (_U(0x1) << PAC_INTFLAGB_HMATRIXHS_Pos)
#define PAC_INTFLAGB_MASK           _U(0x0000003F) /**< \brief (PAC_INTFLAGB) MASK Register */
...
#define PAC_INTFLAGC_EVSYS          (_U(0x1) << PAC_INTFLAGC_EVSYS_Pos)
...
#define PAC_INTFLAGC_SERCOM5        (_U(0x1) << PAC_INTFLAGC_SERCOM5_Pos)
#define PAC_INTFLAGC_CAN0_Pos       7            /**< \brief (PAC_INTFLAGC) CAN0 */
#define PAC_INTFLAGC_CAN0           (_U(0x1) << PAC_INTFLAGC_CAN0_Pos)
#define PAC_INTFLAGC_CAN1_Pos       8            /**< \brief (PAC_INTFLAGC) CAN1 */
#define PAC_INTFLAGC_CAN1           (_U(0x1) << PAC_INTFLAGC_CAN1_Pos)
...
#define PAC_INTFLAGC_ADC0           (_U(0x1) << PAC_INTFLAGC_ADC0_Pos)
#define PAC_INTFLAGC_ADC1_Pos       18           /**< \brief (PAC_INTFLAGC) ADC1 */
#define PAC_INTFLAGC_ADC1           (_U(0x1) << PAC_INTFLAGC_ADC1_Pos)
#define PAC_INTFLAGC_SDADC_Pos      19           /**< \brief (PAC_INTFLAGC) SDADC */
#define PAC_INTFLAGC_SDADC          (_U(0x1) << PAC_INTFLAGC_SDADC_Pos)
...
#define PAC_INTFLAGC_PTC            (_U(0x1) << PAC_INTFLAGC_PTC_Pos)
...
#define PAC_INTFLAGC_TAL            (_U(0x1) << PAC_INTFLAGC_TAL_Pos)
#define PAC_INTFLAGC_MASK           _U(0x01FFFFFF) /**< \brief (PAC_INTFLAGC) MASK Register */

/* -------- PAC_INTFLAGD : (PAC Offset: 0x20) (R/W 32) Peripheral interrupt flag status - Bridge D -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    __I uint32_t SERCOM6_:1;       /*!< bit:      0  SERCOM6                            */
    __I uint32_t SERCOM7_:1;       /*!< bit:      1  SERCOM7                            */
...
#define PAC_INTFLAGD_SERCOM6_Pos    0            /**< \brief (PAC_INTFLAGD) SERCOM6 */
#define PAC_INTFLAGD_SERCOM6        (_U(0x1) << PAC_INTFLAGD_SERCOM6_Pos)
#define PAC_INTFLAGD_SERCOM7_Pos    1            /**< \brief (PAC_INTFLAGD) SERCOM7 */
#define PAC_INTFLAGD_SERCOM7        (_U(0x1) << PAC_INTFLAGD_SERCOM7_Pos)
#define PAC_INTFLAGD_TC5_Pos        2            /**< \brief (PAC_INTFLAGD) TC5 */
#define PAC_INTFLAGD_TC5            (_U(0x1) << PAC_INTFLAGD_TC5_Pos)
#define PAC_INTFLAGD_TC6_Pos        3            /**< \brief (PAC_INTFLAGD) TC6 */
#define PAC_INTFLAGD_TC6            (_U(0x1) << PAC_INTFLAGD_TC6_Pos)
#define PAC_INTFLAGD_TC7_Pos        4            /**< \brief (PAC_INTFLAGD) TC7 */
#define PAC_INTFLAGD_TC7            (_U(0x1) << PAC_INTFLAGD_TC7_Pos)
#define PAC_INTFLAGD_MASK           _U(0x0000001F) /**< \brief (PAC_INTFLAGD) MASK Register */
...
#define PAC_STATUSA_RESETVALUE      _U(0x00000000); /**< \brief (PAC_STATUSA reset_value) Peripheral write protection status - Bridge A */
...
#define PAC_STATUSA_TSENS           (_U(0x1) << PAC_STATUSA_TSENS_Pos)
#define PAC_STATUSA_MASK            _U(0x00001FFF) /**< \brief (PAC_STATUSA) MASK Register */
...
#define PAC_STATUSB_HMATRIXHS       (_U(0x1) << PAC_STATUSB_HMATRIXHS_Pos)
#define PAC_STATUSB_MASK            _U(0x0000003F) /**< \brief (PAC_STATUSB) MASK Register */
...
#define PAC_STATUSC_RESETVALUE      _U(0x02000000); /**< \brief (PAC_STATUSC reset_value) Peripheral write protection status - Bridge C */

#define PAC_STATUSC_EVSYS_Pos       0            /**< \brief (PAC_STATUSC) EVSYS APB Protect Enable */
#define PAC_STATUSC_EVSYS           (_U(0x1) << PAC_STATUSC_EVSYS_Pos)
...
#define PAC_STATUSC_SERCOM5         (_U(0x1) << PAC_STATUSC_SERCOM5_Pos)
#define PAC_STATUSC_CAN0_Pos        7            /**< \brief (PAC_STATUSC) CAN0 APB Protect Enable */
#define PAC_STATUSC_CAN0            (_U(0x1) << PAC_STATUSC_CAN0_Pos)
#define PAC_STATUSC_CAN1_Pos        8            /**< \brief (PAC_STATUSC) CAN1 APB Protect Enable */
#define PAC_STATUSC_CAN1            (_U(0x1) << PAC_STATUSC_CAN1_Pos)
...
#define PAC_STATUSC_ADC0            (_U(0x1) << PAC_STATUSC_ADC0_Pos)
#define PAC_STATUSC_ADC1_Pos        18           /**< \brief (PAC_STATUSC) ADC1 APB Protect Enable */
#define PAC_STATUSC_ADC1            (_U(0x1) << PAC_STATUSC_ADC1_Pos)
#define PAC_STATUSC_SDADC_Pos       19           /**< \brief (PAC_STATUSC) SDADC APB Protect Enable */
#define PAC_STATUSC_SDADC           (_U(0x1) << PAC_STATUSC_SDADC_Pos)
...
#define PAC_STATUSC_PTC             (_U(0x1) << PAC_STATUSC_PTC_Pos)
...
#define PAC_STATUSC_TAL             (_U(0x1) << PAC_STATUSC_TAL_Pos)
#define PAC_STATUSC_MASK            _U(0x01FFFFFF) /**< \brief (PAC_STATUSC) MASK Register */

/* -------- PAC_STATUSD : (PAC Offset: 0x40) (R/  32) Peripheral write protection status - Bridge D -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
    uint32_t SERCOM6_:1;       /*!< bit:      0  SERCOM6 APB Protect Enable         */
    uint32_t SERCOM7_:1;       /*!< bit:      1  SERCOM7 APB Protect Enable         */
    uint32_t TC5_:1;           /*!< bit:      2  TC5 APB Protect Enable             */
    uint32_t TC6_:1;           /*!< bit:      3  TC6 APB Protect Enable             */
    uint32_t TC7_:1;           /*!< bit:      4  TC7 APB Protect Enable             */
...
#define PAC_STATUSD_SERCOM6_Pos     0            /**< \brief (PAC_STATUSD) SERCOM6 APB Protect Enable */
#define PAC_STATUSD_SERCOM6         (_U(0x1) << PAC_STATUSD_SERCOM6_Pos)
#define PAC_STATUSD_SERCOM7_Pos     1            /**< \brief (PAC_STATUSD) SERCOM7 APB Protect Enable */
#define PAC_STATUSD_SERCOM7         (_U(0x1) << PAC_STATUSD_SERCOM7_Pos)
#define PAC_STATUSD_TC5_Pos         2            /**< \brief (PAC_STATUSD) TC5 APB Protect Enable */
#define PAC_STATUSD_TC5             (_U(0x1) << PAC_STATUSD_TC5_Pos)
#define PAC_STATUSD_TC6_Pos         3            /**< \brief (PAC_STATUSD) TC6 APB Protect Enable */
#define PAC_STATUSD_TC6             (_U(0x1) << PAC_STATUSD_TC6_Pos)
#define PAC_STATUSD_TC7_Pos         4            /**< \brief (PAC_STATUSD) TC7 APB Protect Enable */
#define PAC_STATUSD_TC7             (_U(0x1) << PAC_STATUSD_TC7_Pos)
#define PAC_STATUSD_MASK            _U(0x0000001F) /**< \brief (PAC_STATUSD) MASK Register */
