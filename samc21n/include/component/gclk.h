...
#define GCLK_GENCTRL_SRC_Msk        (_U(0x7) << GCLK_GENCTRL_SRC_Pos)
...
#define   GCLK_GENCTRL_SRC_OSC48M_Val     _U(0x6)   /**< \brief (GCLK_GENCTRL) OSC48M oscillator output */
#define   GCLK_GENCTRL_SRC_DPLL96M_Val    _U(0x7)   /**< \brief (GCLK_GENCTRL) DPLL96M output */
...
#define GCLK_GENCTRL_MASK           _U(0xFFFF3F07) /**< \brief (GCLK_GENCTRL) MASK Register */
...
typedef struct {
  ...
  __IO GCLK_PCHCTRL_Type         PCHCTRL[46]; /**< \brief Offset: 0x80 (R/W 32) Peripheral Clock Control */
} Gclk;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
