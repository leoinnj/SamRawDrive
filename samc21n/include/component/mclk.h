...
typedef union {
  struct {
    ...
    uint32_t HPB3_:1;          /*!< bit:     13  HPB3 AHB Clock Mask                */
...
#define MCLK_AHBMASK_RESETVALUE     _U(0x00003CFF); /**< \brief (MCLK_AHBMASK reset_value) AHB Mask */
...
#define MCLK_AHBMASK_HMATRIXHS      (_U(0x1) << MCLK_AHBMASK_HMATRIXHS_Pos)
...
#define MCLK_AHBMASK_CAN0           (_U(0x1) << MCLK_AHBMASK_CAN0_Pos)
#define MCLK_AHBMASK_CAN1_Pos       9            /**< \brief (MCLK_AHBMASK) CAN1 AHB Clock Mask */
#define MCLK_AHBMASK_CAN1           (_U(0x1) << MCLK_AHBMASK_CAN1_Pos)
...
#define MCLK_AHBMASK_DIVAS          (_U(0x1) << MCLK_AHBMASK_DIVAS_Pos)
#define MCLK_AHBMASK_HPB3_Pos       13           /**< \brief (MCLK_AHBMASK) HPB3 AHB Clock Mask */
#define MCLK_AHBMASK_HPB3           (_U(0x1) << MCLK_AHBMASK_HPB3_Pos)
#define MCLK_AHBMASK_MASK           _U(0x00003FFF) /**< \brief (MCLK_AHBMASK) MASK Register */
...
#define MCLK_APBAMASK_RESETVALUE    _U(0x00000FFF); /**< \brief (MCLK_APBAMASK reset_value) APBA Mask */
...
#define MCLK_APBAMASK_TSENS         (_U(0x1) << MCLK_APBAMASK_TSENS_Pos)
#define MCLK_APBAMASK_MASK          _U(0x00001FFF) /**< \brief (MCLK_APBAMASK) MASK Register */
...
#define MCLK_APBBMASK_RESETVALUE    _U(0x00000007); /**< \brief (MCLK_APBBMASK reset_value) APBB Mask */
...
#define MCLK_APBBMASK_HMATRIXHS     (_U(0x1) << MCLK_APBBMASK_HMATRIXHS_Pos)
#define MCLK_APBBMASK_MASK          _U(0x00000027) /**< \brief (MCLK_APBBMASK) MASK Register */
...
#define MCLK_APBCMASK_RESETVALUE    _U(0x00000000); /**< \brief (MCLK_APBCMASK reset_value) APBC Mask */

#define MCLK_APBCMASK_EVSYS_Pos     0            /**< \brief (MCLK_APBCMASK) EVSYS APB Clock Enable */
#define MCLK_APBCMASK_EVSYS         (_U(0x1) << MCLK_APBCMASK_EVSYS_Pos)
...
#define MCLK_APBCMASK_SERCOM5       (_U(0x1) << MCLK_APBCMASK_SERCOM5_Pos)
...
#define MCLK_APBCMASK_ADC0          (_U(0x1) << MCLK_APBCMASK_ADC0_Pos)
#define MCLK_APBCMASK_ADC1_Pos      18           /**< \brief (MCLK_APBCMASK) ADC1 APB Clock Enable */
#define MCLK_APBCMASK_ADC1          (_U(0x1) << MCLK_APBCMASK_ADC1_Pos)
#define MCLK_APBCMASK_SDADC_Pos     19           /**< \brief (MCLK_APBCMASK) SDADC APB Clock Enable */
#define MCLK_APBCMASK_SDADC         (_U(0x1) << MCLK_APBCMASK_SDADC_Pos)
...
#define MCLK_APBCMASK_PTC           (_U(0x1) << MCLK_APBCMASK_PTC_Pos)
...
#define MCLK_APBCMASK_TAL           (_U(0x1) << MCLK_APBCMASK_TAL_Pos)
#define MCLK_APBCMASK_MASK          _U(0x01FFFE7F) /**< \brief (MCLK_APBCMASK) MASK Register */

/* -------- MCLK_APBDMASK : (MCLK Offset: 0x20) (R/W 32) APBD Mask -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
    uint32_t SERCOM6_:1;       /*!< bit:      0  SERCOM6 APB Clock Enable           */
    uint32_t SERCOM7_:1;       /*!< bit:      1  SERCOM7 APB Clock Enable           */
    uint32_t TC5_:1;           /*!< bit:      2  TC5 APB Clock Enable               */
    uint32_t TC6_:1;           /*!< bit:      3  TC6 APB Clock Enable               */
    uint32_t TC7_:1;           /*!< bit:      4  TC7 APB Clock Enable               */
...
#define MCLK_APBDMASK_SERCOM6_Pos   0            /**< \brief (MCLK_APBDMASK) SERCOM6 APB Clock Enable */
#define MCLK_APBDMASK_SERCOM6       (_U(0x1) << MCLK_APBDMASK_SERCOM6_Pos)
#define MCLK_APBDMASK_SERCOM7_Pos   1            /**< \brief (MCLK_APBDMASK) SERCOM7 APB Clock Enable */
#define MCLK_APBDMASK_SERCOM7       (_U(0x1) << MCLK_APBDMASK_SERCOM7_Pos)
#define MCLK_APBDMASK_TC5_Pos       2            /**< \brief (MCLK_APBDMASK) TC5 APB Clock Enable */
#define MCLK_APBDMASK_TC5           (_U(0x1) << MCLK_APBDMASK_TC5_Pos)
#define MCLK_APBDMASK_TC6_Pos       3            /**< \brief (MCLK_APBDMASK) TC6 APB Clock Enable */
#define MCLK_APBDMASK_TC6           (_U(0x1) << MCLK_APBDMASK_TC6_Pos)
#define MCLK_APBDMASK_TC7_Pos       4            /**< \brief (MCLK_APBDMASK) TC7 APB Clock Enable */
#define MCLK_APBDMASK_TC7           (_U(0x1) << MCLK_APBDMASK_TC7_Pos)
#define MCLK_APBDMASK_MASK          _U(0x0000001F) /**< \brief (MCLK_APBDMASK) MASK Register */
