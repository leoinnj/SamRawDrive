...
#define TSENS_CTRLA_RESETVALUE      _U(0x00);    /**< \brief (TSENS_CTRLA reset_value) Control A Register */

#define TSENS_CTRLA_SWRST_Pos       0            /**< \brief (TSENS_CTRLA) Software Reset */
#define TSENS_CTRLA_SWRST           (_U(0x1) << TSENS_CTRLA_SWRST_Pos)
#define TSENS_CTRLA_ENABLE_Pos      1            /**< \brief (TSENS_CTRLA) Enable */
#define TSENS_CTRLA_ENABLE          (_U(0x1) << TSENS_CTRLA_ENABLE_Pos)
#define TSENS_CTRLA_RUNSTDBY_Pos    6            /**< \brief (TSENS_CTRLA) Run in Standby */
#define TSENS_CTRLA_RUNSTDBY        (_U(0x1) << TSENS_CTRLA_RUNSTDBY_Pos)
#define TSENS_CTRLA_MASK            _U(0x43)     /**< \brief (TSENS_CTRLA) MASK Register */
...
#define TSENS_CTRLB_RESETVALUE      _U(0x00);    /**< \brief (TSENS_CTRLB reset_value) Control B Register */

#define TSENS_CTRLB_START_Pos       0            /**< \brief (TSENS_CTRLB) Start Measurement */
#define TSENS_CTRLB_START           (_U(0x1) << TSENS_CTRLB_START_Pos)
#define TSENS_CTRLB_MASK            _U(0x01)     /**< \brief (TSENS_CTRLB) MASK Register */
...
#define TSENS_CTRLC_RESETVALUE      _U(0x00);    /**< \brief (TSENS_CTRLC reset_value) Control C Register */

#define TSENS_CTRLC_WINMODE_Pos     0            /**< \brief (TSENS_CTRLC) Window Monitor Mode */
#define TSENS_CTRLC_WINMODE_Msk     (_U(0x7) << TSENS_CTRLC_WINMODE_Pos)
#define TSENS_CTRLC_WINMODE(value)  (TSENS_CTRLC_WINMODE_Msk & ((value) << TSENS_CTRLC_WINMODE_Pos))
#define   TSENS_CTRLC_WINMODE_DISABLE_Val _U(0x0)   /**< \brief (TSENS_CTRLC) No window mode (default) */
#define   TSENS_CTRLC_WINMODE_ABOVE_Val   _U(0x1)   /**< \brief (TSENS_CTRLC) VALUE greater than WINLT */
#define   TSENS_CTRLC_WINMODE_BELOW_Val   _U(0x2)   /**< \brief (TSENS_CTRLC) VALUE less than WINUT */
#define   TSENS_CTRLC_WINMODE_INSIDE_Val  _U(0x3)   /**< \brief (TSENS_CTRLC) VALUE greater than WINLT and VALUE less than WINUT */
#define   TSENS_CTRLC_WINMODE_OUTSIDE_Val _U(0x4)   /**< \brief (TSENS_CTRLC) VALUE less than WINLT or VALUE greater than WINUT */
#define   TSENS_CTRLC_WINMODE_HYST_ABOVE_Val _U(0x5)   /**< \brief (TSENS_CTRLC) VALUE greater than WINUT with hysteresis to WINLT */
#define   TSENS_CTRLC_WINMODE_HYST_BELOW_Val _U(0x6)   /**< \brief (TSENS_CTRLC) VALUE less than WINLST with hysteresis to WINUT */
...
#define TSENS_CTRLC_FREERUN         (_U(0x1) << TSENS_CTRLC_FREERUN_Pos)
#define TSENS_CTRLC_MASK            _U(0x17)     /**< \brief (TSENS_CTRLC) MASK Register */
...
#define TSENS_EVCTRL_RESETVALUE     _U(0x00);    /**< \brief (TSENS_EVCTRL reset_value) Event Control Register */

#define TSENS_EVCTRL_STARTEI_Pos    0            /**< \brief (TSENS_EVCTRL) Start Conversion Event Input Enable */
#define TSENS_EVCTRL_STARTEI        (_U(0x1) << TSENS_EVCTRL_STARTEI_Pos)
#define TSENS_EVCTRL_STARTINV_Pos   1            /**< \brief (TSENS_EVCTRL) Start Conversion Event Invert Enable */
#define TSENS_EVCTRL_STARTINV       (_U(0x1) << TSENS_EVCTRL_STARTINV_Pos)
#define TSENS_EVCTRL_WINEO_Pos      2            /**< \brief (TSENS_EVCTRL) Window Monitor Event Out */
#define TSENS_EVCTRL_WINEO          (_U(0x1) << TSENS_EVCTRL_WINEO_Pos)
#define TSENS_EVCTRL_MASK           _U(0x07)     /**< \brief (TSENS_EVCTRL) MASK Register */
...
#define TSENS_INTENCLR_RESETVALUE   _U(0x00);    /**< \brief (TSENS_INTENCLR reset_value) Interrupt Enable Clear Register */

#define TSENS_INTENCLR_RESRDY_Pos   0            /**< \brief (TSENS_INTENCLR) Result Ready Interrupt Enable */
#define TSENS_INTENCLR_RESRDY       (_U(0x1) << TSENS_INTENCLR_RESRDY_Pos)
#define TSENS_INTENCLR_OVERRUN_Pos  1            /**< \brief (TSENS_INTENCLR) Overrun Interrupt Enable */
#define TSENS_INTENCLR_OVERRUN      (_U(0x1) << TSENS_INTENCLR_OVERRUN_Pos)
#define TSENS_INTENCLR_WINMON_Pos   2            /**< \brief (TSENS_INTENCLR) Window Monitor Interrupt Enable */
#define TSENS_INTENCLR_WINMON       (_U(0x1) << TSENS_INTENCLR_WINMON_Pos)
#define TSENS_INTENCLR_OVF_Pos      3            /**< \brief (TSENS_INTENCLR) Overflow Interrupt Enable */
#define TSENS_INTENCLR_OVF          (_U(0x1) << TSENS_INTENCLR_OVF_Pos)
#define TSENS_INTENCLR_MASK         _U(0x0F)     /**< \brief (TSENS_INTENCLR) MASK Register */
...
#define TSENS_INTENSET_RESETVALUE   _U(0x00);    /**< \brief (TSENS_INTENSET reset_value) Interrupt Enable Set Register */

#define TSENS_INTENSET_RESRDY_Pos   0            /**< \brief (TSENS_INTENSET) Result Ready Interrupt Enable */
#define TSENS_INTENSET_RESRDY       (_U(0x1) << TSENS_INTENSET_RESRDY_Pos)
#define TSENS_INTENSET_OVERRUN_Pos  1            /**< \brief (TSENS_INTENSET) Overrun Interrupt Enable */
#define TSENS_INTENSET_OVERRUN      (_U(0x1) << TSENS_INTENSET_OVERRUN_Pos)
#define TSENS_INTENSET_WINMON_Pos   2            /**< \brief (TSENS_INTENSET) Window Monitor Interrupt Enable */
#define TSENS_INTENSET_WINMON       (_U(0x1) << TSENS_INTENSET_WINMON_Pos)
#define TSENS_INTENSET_OVF_Pos      3            /**< \brief (TSENS_INTENSET) Overflow Interrupt Enable */
#define TSENS_INTENSET_OVF          (_U(0x1) << TSENS_INTENSET_OVF_Pos)
#define TSENS_INTENSET_MASK         _U(0x0F)     /**< \brief (TSENS_INTENSET) MASK Register */
...
#define TSENS_INTFLAG_RESETVALUE    _U(0x00);    /**< \brief (TSENS_INTFLAG reset_value) Interrupt Flag Status and Clear Register */

#define TSENS_INTFLAG_RESRDY_Pos    0            /**< \brief (TSENS_INTFLAG) Result Ready */
#define TSENS_INTFLAG_RESRDY        (_U(0x1) << TSENS_INTFLAG_RESRDY_Pos)
#define TSENS_INTFLAG_OVERRUN_Pos   1            /**< \brief (TSENS_INTFLAG) Overrun */
#define TSENS_INTFLAG_OVERRUN       (_U(0x1) << TSENS_INTFLAG_OVERRUN_Pos)
#define TSENS_INTFLAG_WINMON_Pos    2            /**< \brief (TSENS_INTFLAG) Window Monitor */
#define TSENS_INTFLAG_WINMON        (_U(0x1) << TSENS_INTFLAG_WINMON_Pos)
#define TSENS_INTFLAG_OVF_Pos       3            /**< \brief (TSENS_INTFLAG) Overflow */
#define TSENS_INTFLAG_OVF           (_U(0x1) << TSENS_INTFLAG_OVF_Pos)
#define TSENS_INTFLAG_MASK          _U(0x0F)     /**< \brief (TSENS_INTFLAG) MASK Register */
...
#define TSENS_STATUS_RESETVALUE     _U(0x00);    /**< \brief (TSENS_STATUS reset_value) Status Register */

#define TSENS_STATUS_OVF_Pos        0            /**< \brief (TSENS_STATUS) Result Overflow */
#define TSENS_STATUS_OVF            (_U(0x1) << TSENS_STATUS_OVF_Pos)
#define TSENS_STATUS_MASK           _U(0x01)     /**< \brief (TSENS_STATUS) MASK Register */
...
#define TSENS_SYNCBUSY_RESETVALUE   _U(0x00000000); /**< \brief (TSENS_SYNCBUSY reset_value) Synchronization Busy Register */

#define TSENS_SYNCBUSY_SWRST_Pos    0            /**< \brief (TSENS_SYNCBUSY) Software Reset Busy */
#define TSENS_SYNCBUSY_SWRST        (_U(0x1) << TSENS_SYNCBUSY_SWRST_Pos)
#define TSENS_SYNCBUSY_ENABLE_Pos   1            /**< \brief (TSENS_SYNCBUSY) Enable Busy */
#define TSENS_SYNCBUSY_ENABLE       (_U(0x1) << TSENS_SYNCBUSY_ENABLE_Pos)
#define TSENS_SYNCBUSY_MASK         _U(0x00000003) /**< \brief (TSENS_SYNCBUSY) MASK Register */
...
#define TSENS_VALUE_RESETVALUE      _U(0x00000000); /**< \brief (TSENS_VALUE reset_value) Value Register */

#define TSENS_VALUE_VALUE_Pos       0            /**< \brief (TSENS_VALUE) Measurement Value */
#define TSENS_VALUE_VALUE_Msk       (_U(0xFFFFFF) << TSENS_VALUE_VALUE_Pos)
#define TSENS_VALUE_VALUE(value)    (TSENS_VALUE_VALUE_Msk & ((value) << TSENS_VALUE_VALUE_Pos))
#define TSENS_VALUE_MASK            _U(0x00FFFFFF) /**< \brief (TSENS_VALUE) MASK Register */
...
#define TSENS_WINLT_RESETVALUE      _U(0x00000000); /**< \brief (TSENS_WINLT reset_value) Window Monitor Lower Threshold Register */

#define TSENS_WINLT_WINLT_Pos       0            /**< \brief (TSENS_WINLT) Window Lower Threshold */
#define TSENS_WINLT_WINLT_Msk       (_U(0xFFFFFF) << TSENS_WINLT_WINLT_Pos)
#define TSENS_WINLT_WINLT(value)    (TSENS_WINLT_WINLT_Msk & ((value) << TSENS_WINLT_WINLT_Pos))
#define TSENS_WINLT_MASK            _U(0x00FFFFFF) /**< \brief (TSENS_WINLT) MASK Register */
...
#define TSENS_WINUT_RESETVALUE      _U(0x00000000); /**< \brief (TSENS_WINUT reset_value) Window Monitor Upper Threshold Register */

#define TSENS_WINUT_WINUT_Pos       0            /**< \brief (TSENS_WINUT) Window Upper Threshold */
#define TSENS_WINUT_WINUT_Msk       (_U(0xFFFFFF) << TSENS_WINUT_WINUT_Pos)
#define TSENS_WINUT_WINUT(value)    (TSENS_WINUT_WINUT_Msk & ((value) << TSENS_WINUT_WINUT_Pos))
#define TSENS_WINUT_MASK            _U(0x00FFFFFF) /**< \brief (TSENS_WINUT) MASK Register */
...
#define TSENS_GAIN_RESETVALUE       _U(0x00000000); /**< \brief (TSENS_GAIN reset_value) Gain Register */

#define TSENS_GAIN_GAIN_Pos         0            /**< \brief (TSENS_GAIN) Time Amplifier Gain */
#define TSENS_GAIN_GAIN_Msk         (_U(0xFFFFFF) << TSENS_GAIN_GAIN_Pos)
#define TSENS_GAIN_GAIN(value)      (TSENS_GAIN_GAIN_Msk & ((value) << TSENS_GAIN_GAIN_Pos))
#define TSENS_GAIN_MASK             _U(0x00FFFFFF) /**< \brief (TSENS_GAIN) MASK Register */
...
#define TSENS_OFFSET_RESETVALUE     _U(0x00000000); /**< \brief (TSENS_OFFSET reset_value) Offset Register */

#define TSENS_OFFSET_OFFSETC_Pos    0            /**< \brief (TSENS_OFFSET) Offset Correction */
#define TSENS_OFFSET_OFFSETC_Msk    (_U(0xFFFFFF) << TSENS_OFFSET_OFFSETC_Pos)
#define TSENS_OFFSET_OFFSETC(value) (TSENS_OFFSET_OFFSETC_Msk & ((value) << TSENS_OFFSET_OFFSETC_Pos))
#define TSENS_OFFSET_MASK           _U(0x00FFFFFF) /**< \brief (TSENS_OFFSET) MASK Register */
...
#define TSENS_CAL_RESETVALUE        _U(0x00000000); /**< \brief (TSENS_CAL reset_value) Calibration Register */

#define TSENS_CAL_FCAL_Pos          0            /**< \brief (TSENS_CAL) Frequency Calibration */
#define TSENS_CAL_FCAL_Msk          (_U(0x3F) << TSENS_CAL_FCAL_Pos)
...
#define TSENS_CAL_TCAL_Msk          (_U(0x3F) << TSENS_CAL_TCAL_Pos)
#define TSENS_CAL_TCAL(value)       (TSENS_CAL_TCAL_Msk & ((value) << TSENS_CAL_TCAL_Pos))
#define TSENS_CAL_MASK              _U(0x00003F3F) /**< \brief (TSENS_CAL) MASK Register */
...
#define TSENS_DBGCTRL_RESETVALUE    _U(0x00);    /**< \brief (TSENS_DBGCTRL reset_value) Debug Control Register */

#define TSENS_DBGCTRL_DBGRUN_Pos    0            /**< \brief (TSENS_DBGCTRL) Debug Run */
#define TSENS_DBGCTRL_DBGRUN        (_U(0x1) << TSENS_DBGCTRL_DBGRUN_Pos)
#define TSENS_DBGCTRL_MASK          _U(0x01)     /**< \brief (TSENS_DBGCTRL) MASK Register */
