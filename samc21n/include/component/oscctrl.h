...
#define OSCCTRL_INTENCLR_XOSCFAIL   (_U(0x1) << OSCCTRL_INTENCLR_XOSCFAIL_Pos)
#define OSCCTRL_INTENCLR_OSC48MRDY_Pos 4            /**< \brief (OSCCTRL_INTENCLR) OSC48M Ready Interrupt Enable */
#define OSCCTRL_INTENCLR_OSC48MRDY  (_U(0x1) << OSCCTRL_INTENCLR_OSC48MRDY_Pos)
...
#define OSCCTRL_INTENCLR_MASK       _U(0x00000F13) /**< \brief (OSCCTRL_INTENCLR) MASK Register */
...
#define OSCCTRL_INTENSET_XOSCFAIL   (_U(0x1) << OSCCTRL_INTENSET_XOSCFAIL_Pos)
#define OSCCTRL_INTENSET_OSC48MRDY_Pos 4            /**< \brief (OSCCTRL_INTENSET) OSC48M Ready Interrupt Enable */
#define OSCCTRL_INTENSET_OSC48MRDY  (_U(0x1) << OSCCTRL_INTENSET_OSC48MRDY_Pos)
...
#define OSCCTRL_INTENSET_MASK       _U(0x00000F13) /**< \brief (OSCCTRL_INTENSET) MASK Register */
...
#define OSCCTRL_INTFLAG_XOSCFAIL    (_U(0x1) << OSCCTRL_INTFLAG_XOSCFAIL_Pos)
#define OSCCTRL_INTFLAG_OSC48MRDY_Pos 4            /**< \brief (OSCCTRL_INTFLAG) OSC48M Ready */
#define OSCCTRL_INTFLAG_OSC48MRDY   (_U(0x1) << OSCCTRL_INTFLAG_OSC48MRDY_Pos)
...
#define OSCCTRL_INTFLAG_MASK        _U(0x00000F13) /**< \brief (OSCCTRL_INTFLAG) MASK Register */
...
#define OSCCTRL_STATUS_XOSCFAIL     (_U(0x1) << OSCCTRL_STATUS_XOSCFAIL_Pos)
#define OSCCTRL_STATUS_XOSCCKSW_Pos 2            /**< \brief (OSCCTRL_STATUS) XOSC Clock Switch */
#define OSCCTRL_STATUS_XOSCCKSW     (_U(0x1) << OSCCTRL_STATUS_XOSCCKSW_Pos)
#define OSCCTRL_STATUS_OSC48MRDY_Pos 4            /**< \brief (OSCCTRL_STATUS) OSC48M Ready */
#define OSCCTRL_STATUS_OSC48MRDY    (_U(0x1) << OSCCTRL_STATUS_OSC48MRDY_Pos)
...
#define OSCCTRL_STATUS_MASK         _U(0x00000F17) /**< \brief (OSCCTRL_STATUS) MASK Register */
...
#define OSCCTRL_XOSCCTRL_MASK       _U(0xFFDE)   /**< \brief (OSCCTRL_XOSCCTRL) MASK Register */
...
#define OSCCTRL_CFDPRESC_RESETVALUE _U(0x00);    /**< \brief (OSCCTRL_CFDPRESC reset_value) Cloc Failure Detector Prescaler */

#define OSCCTRL_CFDPRESC_CFDPRESC_Pos 0            /**< \brief (OSCCTRL_CFDPRESC) Clock Failure Detector Prescaler */
#define OSCCTRL_CFDPRESC_CFDPRESC_Msk (_U(0x7) << OSCCTRL_CFDPRESC_CFDPRESC_Pos)
#define OSCCTRL_CFDPRESC_CFDPRESC(value) (OSCCTRL_CFDPRESC_CFDPRESC_Msk & ((value) << OSCCTRL_CFDPRESC_CFDPRESC_Pos))
#define OSCCTRL_CFDPRESC_MASK       _U(0x07)     /**< \brief (OSCCTRL_CFDPRESC) MASK Register */
...
#define OSCCTRL_EVCTRL_CFDEO        (_U(0x1) << OSCCTRL_EVCTRL_CFDEO_Pos)
#define OSCCTRL_EVCTRL_MASK         _U(0x01)     /**< \brief (OSCCTRL_EVCTRL) MASK Register */
...
#define OSCCTRL_OSC48MCTRL_RESETVALUE _U(0x82);    /**< \brief (OSCCTRL_OSC48MCTRL reset_value) 48MHz Internal Oscillator (OSC48M) Control */

#define OSCCTRL_OSC48MCTRL_ENABLE_Pos 1            /**< \brief (OSCCTRL_OSC48MCTRL) Oscillator Enable */
#define OSCCTRL_OSC48MCTRL_ENABLE   (_U(0x1) << OSCCTRL_OSC48MCTRL_ENABLE_Pos)
#define OSCCTRL_OSC48MCTRL_RUNSTDBY_Pos 6            /**< \brief (OSCCTRL_OSC48MCTRL) Run in Standby */
#define OSCCTRL_OSC48MCTRL_RUNSTDBY (_U(0x1) << OSCCTRL_OSC48MCTRL_RUNSTDBY_Pos)
#define OSCCTRL_OSC48MCTRL_ONDEMAND_Pos 7            /**< \brief (OSCCTRL_OSC48MCTRL) On Demand Control */
#define OSCCTRL_OSC48MCTRL_ONDEMAND (_U(0x1) << OSCCTRL_OSC48MCTRL_ONDEMAND_Pos)
#define OSCCTRL_OSC48MCTRL_MASK     _U(0xC2)     /**< \brief (OSCCTRL_OSC48MCTRL) MASK Register */
...
#define OSCCTRL_OSC48MDIV_RESETVALUE _U(0x0B);    /**< \brief (OSCCTRL_OSC48MDIV reset_value) OSC48M Divider */

#define OSCCTRL_OSC48MDIV_DIV_Pos   0            /**< \brief (OSCCTRL_OSC48MDIV) OSC48M Division Factor */
#define OSCCTRL_OSC48MDIV_DIV_Msk   (_U(0xF) << OSCCTRL_OSC48MDIV_DIV_Pos)
#define OSCCTRL_OSC48MDIV_DIV(value) (OSCCTRL_OSC48MDIV_DIV_Msk & ((value) << OSCCTRL_OSC48MDIV_DIV_Pos))
#define OSCCTRL_OSC48MDIV_MASK      _U(0x0F)     /**< \brief (OSCCTRL_OSC48MDIV) MASK Register */
...
#define OSCCTRL_OSC48MSTUP_RESETVALUE _U(0x07);    /**< \brief (OSCCTRL_OSC48MSTUP reset_value) OSC48M Startup Time */

#define OSCCTRL_OSC48MSTUP_STARTUP_Pos 0            /**< \brief (OSCCTRL_OSC48MSTUP) Startup Time */
#define OSCCTRL_OSC48MSTUP_STARTUP_Msk (_U(0x7) << OSCCTRL_OSC48MSTUP_STARTUP_Pos)
#define OSCCTRL_OSC48MSTUP_STARTUP(value) (OSCCTRL_OSC48MSTUP_STARTUP_Msk & ((value) << OSCCTRL_OSC48MSTUP_STARTUP_Pos))
#define OSCCTRL_OSC48MSTUP_MASK     _U(0x07)     /**< \brief (OSCCTRL_OSC48MSTUP) MASK Register */
...
#define OSCCTRL_OSC48MSYNCBUSY_RESETVALUE _U(0x00000000); /**< \brief (OSCCTRL_OSC48MSYNCBUSY reset_value) OSC48M Synchronization Busy */

#define OSCCTRL_OSC48MSYNCBUSY_OSC48MDIV_Pos 2            /**< \brief (OSCCTRL_OSC48MSYNCBUSY) OSC48MDIV Synchronization Status */
#define OSCCTRL_OSC48MSYNCBUSY_OSC48MDIV (_U(0x1) << OSCCTRL_OSC48MSYNCBUSY_OSC48MDIV_Pos)
#define OSCCTRL_OSC48MSYNCBUSY_MASK _U(0x00000004) /**< \brief (OSCCTRL_OSC48MSYNCBUSY) MASK Register */
...
#define OSCCTRL_CAL48M_RESETVALUE   _U(0x00000000); /**< \brief (OSCCTRL_CAL48M reset_value) 48MHz Oscillator Calibration */

#define OSCCTRL_CAL48M_FCAL_Pos     0            /**< \brief (OSCCTRL_CAL48M) Frequency Calibration (48MHz) */
#define OSCCTRL_CAL48M_FCAL_Msk     (_U(0x3F) << OSCCTRL_CAL48M_FCAL_Pos)
...
#define OSCCTRL_CAL48M_FRANGE_Msk   (_U(0x3) << OSCCTRL_CAL48M_FRANGE_Pos)
...
#define OSCCTRL_CAL48M_TCAL_Msk     (_U(0x3F) << OSCCTRL_CAL48M_TCAL_Pos)
#define OSCCTRL_CAL48M_TCAL(value)  (OSCCTRL_CAL48M_TCAL_Msk & ((value) << OSCCTRL_CAL48M_TCAL_Pos))
#define OSCCTRL_CAL48M_MASK         _U(0x003F033F) /**< \brief (OSCCTRL_CAL48M) MASK Register */
