...
#define FREQM_CFGA_DIVREF_Pos       15           /**< \brief (FREQM_CFGA) Divide Reference Clock */
#define FREQM_CFGA_DIVREF           (_U(0x1) << FREQM_CFGA_DIVREF_Pos)
#define FREQM_CFGA_MASK             _U(0x80FF)   /**< \brief (FREQM_CFGA) MASK Register */
