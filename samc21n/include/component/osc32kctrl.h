...
#define OSC32KCTRL_INTENCLR_CLKFAIL (_U(0x1) << OSC32KCTRL_INTENCLR_CLKFAIL_Pos)
#define OSC32KCTRL_INTENCLR_MASK    _U(0x00000007) /**< \brief (OSC32KCTRL_INTENCLR) MASK Register */
...
#define OSC32KCTRL_INTENSET_CLKFAIL (_U(0x1) << OSC32KCTRL_INTENSET_CLKFAIL_Pos)
#define OSC32KCTRL_INTENSET_MASK    _U(0x00000007) /**< \brief (OSC32KCTRL_INTENSET) MASK Register */
...
#define OSC32KCTRL_INTFLAG_CLKFAIL  (_U(0x1) << OSC32KCTRL_INTFLAG_CLKFAIL_Pos)
#define OSC32KCTRL_INTFLAG_MASK     _U(0x00000007) /**< \brief (OSC32KCTRL_INTFLAG) MASK Register */
...
#define OSC32KCTRL_STATUS_CLKFAIL   (_U(0x1) << OSC32KCTRL_STATUS_CLKFAIL_Pos)
#define OSC32KCTRL_STATUS_CLKSW_Pos 3            /**< \brief (OSC32KCTRL_STATUS) XOSC32K Clock switch */
#define OSC32KCTRL_STATUS_CLKSW     (_U(0x1) << OSC32KCTRL_STATUS_CLKSW_Pos)
#define OSC32KCTRL_STATUS_MASK      _U(0x0000000F) /**< \brief (OSC32KCTRL_STATUS) MASK Register */
...
#define OSC32KCTRL_XOSC32K_RESETVALUE _U(0x0080);  /**< \brief (OSC32KCTRL_XOSC32K reset_value) 32kHz External Crystal Oscillator (XOSC32K) Control */
...
#define OSC32KCTRL_XOSC32K_MASK     _U(0x17DE)   /**< \brief (OSC32KCTRL_XOSC32K) MASK Register */
