...
#define   CCL_LUTCTRL_INSEL0_ALT2TC_Val   _U(0xA)   /**< \brief (CCL_LUTCTRL) Alternate 2 TC input source */
#define   CCL_LUTCTRL_INSEL0_ASYNCEVENT_Val _U(0xB)   /**< \brief (CCL_LUTCTRL) ASYNC EVENT input source. The EVENT input will bypass edge detection logic. */
