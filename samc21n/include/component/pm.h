...
#define PM_SLEEPCFG_RESETVALUE      _U(0x00);    /**< \brief (PM_SLEEPCFG reset_value) Sleep Configuration */
...
#define PM_STDBYCFG_RESETVALUE      _U(0x0400);  /**< \brief (PM_STDBYCFG reset_value) Standby Configuration */
...
#define PM_STDBYCFG_MASK            _U(0x0CC0)   /**< \brief (PM_STDBYCFG) MASK Register */
