 ...
 * \file
 *
 * \brief Header file for SAMC21N17A
 *
 ...
 * \addtogroup SAMC21N17A_definitions SAMC21N17A definitions
 * This file defines all structures and symbols for SAMC21N17A:
...
/* ************************************************************************** */
/**  CMSIS DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  /******  SAMC21N17A-specific Interrupt Numbers ***********************/
  SYSTEM_IRQn              =  0, /**<  0 SAMC21N17A System Interrupts */
  WDT_IRQn                 =  1, /**<  1 SAMC21N17A Watchdog Timer (WDT) */
  RTC_IRQn                 =  2, /**<  2 SAMC21N17A Real-Time Counter (RTC) */
  EIC_IRQn                 =  3, /**<  3 SAMC21N17A External Interrupt Controller (EIC) */
  FREQM_IRQn               =  4, /**<  4 SAMC21N17A Frequency Meter (FREQM) */
  TSENS_IRQn               =  5, /**<  5 SAMC21N17A Temperature Sensor (TSENS) */
  NVMCTRL_IRQn             =  6, /**<  6 SAMC21N17A Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  7, /**<  7 SAMC21N17A Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMC21N17A Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMC21N17A Serial Communication Interface 0 (SERCOM0) */
  SERCOM6_IRQn             =  9, /**<  9 SAMC21N17A Serial Communication Interface 6 (SERCOM6) */
  SERCOM1_IRQn             = 10, /**< 10 SAMC21N17A Serial Communication Interface 1 (SERCOM1) */
  SERCOM7_IRQn             = 10, /**< 10 SAMC21N17A Serial Communication Interface 7 (SERCOM7) */
  SERCOM2_IRQn             = 11, /**< 11 SAMC21N17A Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMC21N17A Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMC21N17A Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMC21N17A Serial Communication Interface 5 (SERCOM5) */
  CAN0_IRQn                = 15, /**< 15 SAMC21N17A Control Area Network 0 (CAN0) */
  CAN1_IRQn                = 16, /**< 16 SAMC21N17A Control Area Network 1 (CAN1) */
  TCC0_IRQn                = 17, /**< 17 SAMC21N17A Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 18, /**< 18 SAMC21N17A Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 19, /**< 19 SAMC21N17A Timer Counter Control 2 (TCC2) */
  TC0_IRQn                 = 20, /**< 20 SAMC21N17A Basic Timer Counter 0 (TC0) */
  TC5_IRQn                 = 20, /**< 20 SAMC21N17A Basic Timer Counter 5 (TC5) */
  TC1_IRQn                 = 21, /**< 21 SAMC21N17A Basic Timer Counter 1 (TC1) */
  TC6_IRQn                 = 21, /**< 21 SAMC21N17A Basic Timer Counter 6 (TC6) */
  TC2_IRQn                 = 22, /**< 22 SAMC21N17A Basic Timer Counter 2 (TC2) */
  TC7_IRQn                 = 22, /**< 22 SAMC21N17A Basic Timer Counter 7 (TC7) */
  TC3_IRQn                 = 23, /**< 23 SAMC21N17A Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 24, /**< 24 SAMC21N17A Basic Timer Counter 4 (TC4) */
  ADC0_IRQn                = 25, /**< 25 SAMC21N17A Analog Digital Converter 0 (ADC0) */
  ADC1_IRQn                = 26, /**< 26 SAMC21N17A Analog Digital Converter 1 (ADC1) */
  AC_IRQn                  = 27, /**< 27 SAMC21N17A Analog Comparators (AC) */
  DAC_IRQn                 = 28, /**< 28 SAMC21N17A Digital Analog Converter (DAC) */
  SDADC_IRQn               = 29, /**< 29 SAMC21N17A Sigma-Delta Analog Digital Converter (SDADC) */
  PTC_IRQn                 = 30, /**< 30 SAMC21N17A Peripheral Touch Controller (PTC) */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnINT9_Handler;                  /*  9 Serial Communication Interface 0, Serial Communication Interface 6 */
  void* pfnINT10_Handler;                 /* 10 Serial Communication Interface 1, Serial Communication Interface 7 */
  ...
  void* pfnINT20_Handler;                 /* 20 Basic Timer Counter 0, Basic Timer Counter 5 */
  void* pfnINT21_Handler;                 /* 21 Basic Timer Counter 1, Basic Timer Counter 6 */
  void* pfnINT22_Handler;                 /* 22 Basic Timer Counter 2, Basic Timer Counter 7 */
...
#define TC0_Handler              INT20_Handler
#define TC5_Handler              INT20_Handler
void INT21_Handler               ( void );
#define TC1_Handler              INT21_Handler
#define TC6_Handler              INT21_Handler
void INT22_Handler               ( void );
#define TC2_Handler              INT22_Handler
#define TC7_Handler              INT22_Handler
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PERIPHERAL ID DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_id Peripheral Ids Definitions */
/*@{*/
...
#define ID_SERCOM6       96 /**< \brief Serial Communication Interface 6 (SERCOM6) */
#define ID_SERCOM7       97 /**< \brief Serial Communication Interface 7 (SERCOM7) */
#define ID_TC5           98 /**< \brief Basic Timer Counter 5 (TC5) */
#define ID_TC6           99 /**< \brief Basic Timer Counter 6 (TC6) */
#define ID_TC7          100 /**< \brief Basic Timer Counter 7 (TC7) */

// Peripheral instances on AHB (as if on bridge 4)
#define ID_DIVAS        128 /**< \brief Divide and Square Root Accelerator (DIVAS) */

#define ID_PERIPH_COUNT 129 /**< \brief Max number of peripheral IDs */
/*@}*/

/* ************************************************************************** */
/**  BASE ADDRESS DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_base Peripheral Base Address Definitions */
/*@{*/
...
#define SERCOM6                       (0x43000000) /**< \brief (SERCOM6) APB Base Address */
#define SERCOM7                       (0x43000400) /**< \brief (SERCOM7) APB Base Address */
#define SUPC                          (0x40001800) /**< \brief (SUPC) APB Base Address */
#define TAL                           (0x42006000) /**< \brief (TAL) APB Base Address */
...
#define TC5                           (0x43000800) /**< \brief (TC5) APB Base Address */
#define TC6                           (0x43000C00) /**< \brief (TC6) APB Base Address */
#define TC7                           (0x43001000) /**< \brief (TC7) APB Base Address */
...
#define SERCOM6           ((Sercom   *)0x43000000UL) /**< \brief (SERCOM6) APB Base Address */
#define SERCOM7           ((Sercom   *)0x43000400UL) /**< \brief (SERCOM7) APB Base Address */
...
#define TC5               ((Tc       *)0x43000800UL) /**< \brief (TC5) APB Base Address */
#define TC6               ((Tc       *)0x43000C00UL) /**< \brief (TC6) APB Base Address */
#define TC7               ((Tc       *)0x43001000UL) /**< \brief (TC7) APB Base Address */
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
/** \defgroup SAMC21N17A_port PORT Definitions */
/*@{*/

#include "pio/samc21n17a.h"
/*@}*/

/* ************************************************************************** */
/**  MEMORY MAPPING DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
...
#define DSU_DID_RESETVALUE    _UL(0x11011401)
#define AC_PAIRS              2
...
/* ************************************************************************** */
/**  ELECTRICAL DEFINITIONS FOR SAMC21N17A */
/* ************************************************************************** */
