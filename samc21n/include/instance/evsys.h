...
#define REG_EVSYS_USER47           (0x4200013C) /**< \brief (EVSYS) User Multiplexer 47 */
#define REG_EVSYS_USER48           (0x42000140) /**< \brief (EVSYS) User Multiplexer 48 */
#define REG_EVSYS_USER49           (0x42000144) /**< \brief (EVSYS) User Multiplexer 49 */
#else
...
#define REG_EVSYS_USER47           (*(RwReg  *)0x4200013CUL) /**< \brief (EVSYS) User Multiplexer 47 */
#define REG_EVSYS_USER48           (*(RwReg  *)0x42000140UL) /**< \brief (EVSYS) User Multiplexer 48 */
#define REG_EVSYS_USER49           (*(RwReg  *)0x42000144UL) /**< \brief (EVSYS) User Multiplexer 49 */
...
#define EVSYS_GENERATORS            96       // Total Number of Event Generators
#define EVSYS_GENERATORS_BITS       7        // Number of bits to select Event Generator
#define EVSYS_USERS                 50       // Total Number of Event Users
...
#define EVSYS_ID_USER_TC5_EVU       47
#define EVSYS_ID_USER_TC6_EVU       48
#define EVSYS_ID_USER_TC7_EVU       49
